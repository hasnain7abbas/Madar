...
export const simulations: Simulation[] = [
  ...
  // ==========================================================================
  //  NEW SIMULATIONS – Additional PhET & Other Sources
  // ==========================================================================
  ...
  // ── Physics: Additional ──
  {
    ...
    name: "Masses and Springs: Basics",
    description:
      "Hang masses from springs and discover how they stretch and oscillate. A simplified version for younger learners.",
    category: "physics",
    subcategory: "mechanics",
    gradeLevel: "Middle School",
    source: "PhET",
    embedUrl: phet("masses-and-springs-basics"),
    thumbnailEmoji: "🪀",
    tags: ["spring", "mass", "oscillation", "Hooke's law", "equilibrium"],
  },
  {
    id: "phet-wave-interference",
    name: "Wave Interference",
    description:
      "Make waves with a dripping faucet, audio speaker, or laser. Observe interference patterns in water, sound, and light.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("wave-interference"),
    thumbnailEmoji: "🌊",
    tags: ["wave", "interference", "diffraction", "double slit", "sound", "light"],
  },
  {
    id: "phet-geometric-optics-basics",
    name: "Geometric Optics: Basics",
    description:
      "Explore how lenses and mirrors form images. A beginner-friendly version of the geometric optics simulation.",
    category: "physics",
    subcategory: "optics",
    gradeLevel: "Middle School",
    source: "PhET",
    embedUrl: phet("geometric-optics-basics"),
    thumbnailEmoji: "🔍",
    tags: ["lens", "mirror", "image", "focal point", "optics basics"],
  },
  {
    id: "phet-circuit-construction-kit-dc-virtual-lab",
    name: "Circuit Construction Kit: DC - Virtual Lab",
    description:
      "Build circuits with batteries, resistors, light bulbs, fuses, and switches. Take measurements with a realistic ammeter and voltmeter.",
    category: "physics",
    subcategory: "electricity",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("circuit-construction-kit-dc-virtual-lab"),
    thumbnailEmoji: "🔬",
    tags: ["circuit", "DC", "ammeter", "voltmeter", "virtual lab", "resistor"],
  },
  {
    id: "phet-keplers-laws",
    name: "Kepler's Laws",
    description:
      "Explore how Kepler's three laws describe the motion of planets. Adjust orbital parameters and discover elliptical orbits.",
    category: "physics",
    subcategory: "astronomy",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("keplers-laws"),
    thumbnailEmoji: "🪐",
    tags: ["Kepler", "orbit", "ellipse", "planet", "period", "area"],
  },
  {
    id: "phet-my-solar-system",
    name: "My Solar System",
    description:
      "Build your own solar system. Set initial positions, velocities, and masses of multiple bodies and watch gravity create orbits.",
    category: "physics",
    subcategory: "astronomy",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("my-solar-system"),
    thumbnailEmoji: "☀️",
    tags: ["solar system", "orbit", "gravity", "N-body", "planet", "star"],
  },
  {
    id: "phet-center-and-variability",
    name: "Center and Variability",
    description:
      "Explore measures of center (mean, median) and variability through interactive data visualization.",
    category: "math",
    subcategory: "statistics",
    gradeLevel: "Middle School",
    source: "PhET",
    embedUrl: phet("center-and-variability"),
    thumbnailEmoji: "📊",
    tags: ["mean", "median", "variability", "statistics", "data", "distribution"],
  },
  {
    id: "phet-mean-share-and-balance",
    name: "Mean: Share and Balance",
    description:
      "Learn the concept of mean by sharing and balancing quantities across multiple scenarios.",
    category: "math",
    subcategory: "statistics",
    gradeLevel: "Middle School",
    source: "PhET",
    embedUrl: phet("mean-share-and-balance"),
    thumbnailEmoji: "⚖️",
    tags: ["mean", "average", "fair share", "balance", "statistics"],
  },
  {
    id: "phet-number-line-integers",
    name: "Number Line: Integers",
    description:
      "Explore integers, their absolute values, and operations on a number line.",
    category: "math",
    subcategory: "arithmetic",
    gradeLevel: "Middle School",
    source: "PhET",
    embedUrl: phet("number-line-integers"),
    thumbnailEmoji: "🔢",
    tags: ["integer", "number line", "absolute value", "negative", "positive"],
  },
  {
    id: "phet-number-line-operations",
    name: "Number Line: Operations",
    description:
      "Visualize addition and subtraction of integers on a number line with interactive arrows.",
    category: "math",
    subcategory: "arithmetic",
    gradeLevel: "Middle School",
    source: "PhET",
    embedUrl: phet("number-line-operations"),
    thumbnailEmoji: "➕",
    tags: ["addition", "subtraction", "integer", "number line", "operations"],
  },
  {
    id: "phet-number-line-distance",
    name: "Number Line: Distance",
    description:
      "Explore distance and absolute value concepts using an interactive number line.",
    category: "math",
    subcategory: "arithmetic",
    gradeLevel: "Middle School",
    source: "PhET",
    embedUrl: phet("number-line-distance"),
    thumbnailEmoji: "📏",
    tags: ["distance", "absolute value", "number line", "integers"],
  },
  {
    id: "phet-number-play",
    name: "Number Play",
    description:
      "Play with numbers! Decompose, compare, and build number sense with visual models.",
    category: "math",
    subcategory: "arithmetic",
    gradeLevel: "Elementary School",
    source: "PhET",
    embedUrl: phet("number-play"),
    thumbnailEmoji: "🎲",
    tags: ["counting", "decompose", "number sense", "comparison", "tens"],
  },
  {
    id: "phet-number-compare",
    name: "Number Compare",
    description:
      "Compare numbers and build number sense with visual representations.",
    category: "math",
    subcategory: "arithmetic",
    gradeLevel: "Elementary School",
    source: "PhET",
    embedUrl: phet("number-compare"),
    thumbnailEmoji: "🔄",
    tags: ["compare", "greater than", "less than", "equal", "number sense"],
  },
  {
    id: "phet-calculus-grapher",
    name: "Calculus Grapher",
    description:
      "Draw f(x) and see its derivative f'(x) and integral. Explore the fundamental theorem of calculus interactively.",
    category: "math",
    subcategory: "calculus",
    gradeLevel: "College",
    source: "PhET",
  ...
  // ── Chemistry: Additional ──
  {
    ...
    name: "Acid-Base Solutions",
    description:
      "Explore the behavior of acids, bases, and salts in solution. Measure pH, conductivity, and observe molecular-level behavior.",
    category: "chemistry",
    ...
    embedUrl: phet("acid-base-solutions"),
    thumbnailEmoji: "🧫",
    tags: ["acid", "base", "pH", "solution", "conductivity", "indicator"],
  },
  {
    id: "phet-ph-scale-basics",
    name: "pH Scale: Basics",
    description:
      "Test the pH of everyday liquids like coffee, spit, and soap. See if a substance is acidic or basic.",
    category: "chemistry",
    subcategory: "acid-base",
    gradeLevel: "Middle School",
    source: "PhET",
    embedUrl: phet("ph-scale-basics"),
    thumbnailEmoji: "🧪",
    tags: ["pH", "acid", "base", "neutral", "indicator", "scale"],
  },
  ...
  // ── Earth Science: Additional ──
  {
    ...
    name: "Greenhouse Effect",
    description:
      "How do greenhouse gases affect the climate? Explore the atmosphere during the ice age, in 1750, today, and in the future.",
    category: "earth-science",
    ...
    embedUrl: phet("greenhouse-effect"),
    thumbnailEmoji: "🌡️",
    tags: ["greenhouse", "climate", "CO2", "infrared", "atmosphere", "temperature"],
  },
  {
  ...
  },
  {
    ...
    name: "Plate Tectonics",
    description:
      "Explore how plates move on the surface of the earth. Change temperature, composition, and thickness to see how it affects plate motion.",
    category: "earth-science",
    subcategory: "geology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("plate-tectonics"),
    thumbnailEmoji: "🌋",
    tags: ["plate tectonics", "continent", "crust", "mantle", "earthquake", "volcano"],
  },
  ...
  },
  {
    ...
    name: "Energy Forms and Changes",
    description:
      "Explore how heating and cooling iron, brick, and water transforms energy. See how energy is transferred between objects.",
    category: "engineering",
    ...
    embedUrl: phet("energy-forms-and-changes"),
    thumbnailEmoji: "🔥",
    tags: ["energy", "heat", "transfer", "thermal", "mechanical", "electrical"],
  },

  // ── Physics: oPhysics ──
  {
    id: "ophysics-projectile-motion-2",
  ...
  {
    id: "ophysics-electric-field-lines",
  ...
  {
    id: "ophysics-lens-image",
    name: "Thin Lens Image Formation",
    description:
      "Explore how a thin lens forms images. Move the object and see how the image changes in position, size, and orientation.",
    category: "physics",
    subcategory: "optics",
    gradeLevel: "High School",
    source: "oPhysics",
    embedUrl: "https://ophysics.com/l11.html",
    thumbnailEmoji: "🔭",
    tags: ["lens", "image", "focal length", "magnification", "real image", "virtual image"],
  },
  {
    id: "ophysics-roller-coaster",
  ...
  },
  {
    ...
    description:
      "Explore normal, binomial, and other distributions. Calculate probabilities and visualize distributions interactively.",
    category: "math",
    ...
    embedUrl: "https://www.geogebra.org/probability",
    thumbnailEmoji: "🎰",
    tags: ["probability", "distribution", "normal", "binomial", "statistics"],
  },
  {
    id: "geogebra-geometry",
    name: "Geometry Tool",
    description:
      "Interactive geometry tool for constructing and exploring geometric shapes, angles, and transformations.",
    category: "math",
    subcategory: "geometry",
    gradeLevel: "Middle School",
    source: "GeoGebra",
    embedUrl: "https://www.geogebra.org/geometry",
    thumbnailEmoji: "📐",
    tags: ["geometry", "shapes", "angles", "construction", "transformation"],
  },
  ...
  // ── Math: Desmos ──
  {
    ...
    description:
      "A beautiful, free online scientific calculator with trig, logarithms, and more.",
    category: "math",
    ...
    embedUrl: "https://www.desmos.com/scientific",
    thumbnailEmoji: "🔬",
    tags: ["calculator", "scientific", "trig", "logarithm", "exponent"],
  },
  {
    id: "desmos-matrix-calculator",
  ...
  // ── Biology: Additional PhET ──
  {
    id: "phet-natural-selection2",
    name: "Natural Selection",
    description:
      "Explore natural selection by controlling the environment for a population of bunnies. Will they survive?",
    category: "biology",
    subcategory: "evolution",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("natural-selection"),
    thumbnailEmoji: "🐰",
    tags: ["natural selection", "evolution", "bunny", "mutation", "adaptation", "survival"],
  },
  {
    id: "phet-gene-expression-essentials2",
    name: "Gene Expression Essentials",
    description:
      "Express a gene by building the mRNA transcript and translating it to make a protein.",
    category: "biology",
    subcategory: "molecular biology",
    gradeLevel: "College",
    source: "PhET",
    embedUrl: phet("gene-expression-essentials"),
    thumbnailEmoji: "🧬",
    tags: ["gene", "transcription", "translation", "mRNA", "protein", "ribosome"],
  },
  {
    id: "phet-neuron2",
    name: "Neuron",
    description:
      "Stimulate a neuron and observe what happens. See how ions move across the cell membrane to generate an action potential.",
    category: "biology",
    subcategory: "neuroscience",
    gradeLevel: "College",
    source: "PhET",
    embedUrl: phet("neuron"),
    thumbnailEmoji: "🧠",
    tags: ["neuron", "action potential", "ion", "membrane", "sodium", "potassium"],
  },
];
