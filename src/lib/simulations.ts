...
export const simulations: Simulation[] = [
  ...
  // ── Physics: oPhysics ──
  {
    id: "ophysics-projectile-advanced",
    name: "Projectile Motion (Advanced)",
    description:
      "A detailed projectile motion simulator with adjustable launch angle, speed, and air resistance. Trace the full trajectory.",
    category: "physics",
    subcategory: "mechanics",
    gradeLevel: "High School",
    source: "oPhysics",
    embedUrl: "https://ophysics.com/k8.html",
    thumbnailEmoji: "🎯",
    tags: ["projectile", "trajectory", "angle", "velocity", "range", "air resistance"],
  },
  {
    id: "ophysics-shm-spring",
    name: "Simple Harmonic Motion (Spring)",
    description:
      "Visualize simple harmonic motion with a mass on a spring. See displacement, velocity, and acceleration graphs in real time.",
    category: "physics",
    subcategory: "mechanics",
    gradeLevel: "High School",
    source: "oPhysics",
    embedUrl: "https://ophysics.com/w1.html",
    thumbnailEmoji: "📈",
    tags: ["SHM", "spring", "oscillation", "period", "amplitude", "harmonic"],
  },
  {
    id: "ophysics-standing-waves-string",
    name: "Standing Waves on a String",
    description:
      "Create standing wave patterns on a string. Adjust frequency, tension, and density to find resonance.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "High School",
    source: "oPhysics",
    embedUrl: "https://ophysics.com/w6.html",
    thumbnailEmoji: "🎸",
    tags: ["standing wave", "resonance", "harmonic", "node", "antinode", "string"],
  },
  {
    id: "ophysics-efield-lines",
    name: "Electric Field Lines",
    description:
      "Place positive and negative charges and watch the electric field lines form. Understand field direction and strength.",
    category: "physics",
    subcategory: "electricity",
    gradeLevel: "High School",
    source: "oPhysics",
    embedUrl: "https://ophysics.com/em1.html",
    thumbnailEmoji: "⚡",
    tags: ["electric field", "field lines", "charge", "Coulomb", "positive", "negative"],
  },
  {
    id: "ophysics-roller-coaster-energy",
    name: "Roller Coaster (Energy Conservation)",
    description:
      "Design a roller coaster track and explore conservation of energy. Watch kinetic and potential energy exchange as the cart moves.",
    category: "physics",
    subcategory: "mechanics",
    gradeLevel: "High School",
    source: "oPhysics",
    embedUrl: "https://ophysics.com/e2.html",
    thumbnailEmoji: "🎢",
    tags: ["energy conservation", "kinetic", "potential", "roller coaster", "gravity"],
  },

  // ── Engineering: Additional ──
  {
    id: "phet-circuit-construction-kit-ac-virtual-lab",
    name: "Circuit Construction Kit: AC - Virtual Lab",
    description:
      "Build and analyze AC circuits with capacitors, inductors, and resistors. Explore RLC circuits and AC behavior.",
    category: "engineering",
    subcategory: "electrical engineering",
    gradeLevel: "College",
    source: "PhET",
    embedUrl: phet("circuit-construction-kit-ac-virtual-lab"),
    thumbnailEmoji: "🔌",
    tags: ["AC", "circuit", "capacitor", "inductor", "RLC", "frequency", "impedance"],
  },

  // ── Earth Science: Additional ──
  {
    id: "phet-molecules-and-light-earth",
    name: "Molecules and Light (Earth Science)",
    description:
      "How does light interact with atmospheric molecules? Understand why greenhouse gases absorb infrared radiation.",
    category: "earth-science",
    subcategory: "atmosphere",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("molecules-and-light"),
    thumbnailEmoji: "💨",
    tags: ["molecule", "light", "infrared", "photon", "greenhouse gas", "absorption"],
  },

  // ── Math: GeoGebra ──
  {
    id: "geogebra-3d-graphing",
    name: "3D Graphing Calculator",
    description:
      "A powerful 3D graphing calculator. Plot surfaces, lines, and points in three dimensions.",
    category: "math",
    subcategory: "graphing",
    gradeLevel: "College",
    source: "GeoGebra",
    embedUrl: "https://www.geogebra.org/3d",
    thumbnailEmoji: "📦",
    tags: ["3D", "graph", "surface", "plotting", "coordinates", "space"],
  },

  // ── Math: Desmos ──
  {
    id: "desmos-matrix-calc",
    name: "Matrix Calculator",
    description:
      "Perform matrix operations: multiplication, determinants, inverses, eigenvalues and more.",
    category: "math",
    subcategory: "linear algebra",
    gradeLevel: "College",
    source: "Desmos",
    embedUrl: "https://www.desmos.com/matrix",
    thumbnailEmoji: "🧮",
    tags: ["matrix", "determinant", "inverse", "linear algebra", "eigenvalue"],
  },

  // ==========================================================================
  //  FALSTAD — Waves & Acoustics
  // ==========================================================================
  {
    id: "falstad-ripple-tank",
    name: "Ripple Tank",
    description:
      "Simulate 2D water waves showing interference, diffraction, refraction and the Doppler effect in a virtual ripple tank.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "High School",
    source: "Falstad",
    ...
    thumbnailEmoji: "🌊",
    tags: ["wave", "interference", "diffraction", "refraction", "doppler"],
  },
  {
    id: "falstad-wave-2d",
    name: "2D Wave Simulation",
    description:
      "Explore two-dimensional wave behaviour on a vibrating membrane with adjustable boundary conditions.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "High School",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/wave2d/",
    thumbnailEmoji: "🔵",
    tags: ["wave", "2D", "membrane", "vibration"],
  },
  {
    id: "falstad-wave-3d",
    name: "3D Waves in a Box",
    description:
      "Visualise three-dimensional standing waves and resonance patterns inside a rectangular cavity.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/wavebox/",
    thumbnailEmoji: "📦",
    tags: ["wave", "3D", "standing wave", "resonance"],
  },
  {
    id: "falstad-coupled",
    name: "Coupled Oscillations",
    description:
      "Watch how energy transfers between coupled oscillators connected by springs in longitudinal and transverse modes.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "High School",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/coupled/",
    thumbnailEmoji: "🔗",
    tags: ["oscillation", "spring", "longitudinal", "wave"],
  },
  {
    id: "falstad-loaded-string",
    name: "Loaded String (Standing Waves)",
    description:
      "Observe standing wave patterns and harmonics on a string loaded with point masses.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "High School",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/loadedstring/",
    thumbnailEmoji: "🎸",
    tags: ["string", "standing wave", "harmonics", "vibration"],
  },
  {
    id: "falstad-membrane",
    name: "Rectangular Membrane Modes",
    description:
      "See vibration modes of a rectangular membrane — the 2D analogue of a vibrating string.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/membrane/",
    thumbnailEmoji: "🥁",
    tags: ["membrane", "vibration", "mode", "2D wave"],
  },
  {
    id: "falstad-circular-membrane",
    name: "Circular Membrane (Drum)",
    description:
      "Visualise vibration modes of a circular drum-head described by Bessel functions.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/circosc/",
    thumbnailEmoji: "🪘",
    tags: ["drum", "circular", "vibration", "Bessel"],
  },
  {
    id: "falstad-fourier",
    name: "Fourier Series",
    description:
      "Build any periodic waveform by adding sine harmonics and watch the Fourier series converge.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "High School",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/fourier/",
    thumbnailEmoji: "📊",
    tags: ["Fourier", "frequency", "harmonics", "periodic"],
  },
  {
    id: "falstad-interference",
    name: "Acoustic Interference",
    description:
      "Hear and see constructive and destructive interference from two speakers in a 2D room.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "High School",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/interference/",
    thumbnailEmoji: "🔊",
    tags: ["sound", "interference", "speakers", "acoustic"],
  },
  {
    id: "falstad-dispersion",
    name: "Dispersion & Group Velocity",
    description:
      "Explore how wave packets spread out over time and the difference between phase and group velocity.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/dispersion/",
    thumbnailEmoji: "🌈",
    tags: ["dispersion", "group velocity", "phase velocity"],
  },
  {
    id: "falstad-diffraction",
    name: "Fresnel Diffraction",
    description:
      "Simulate Fresnel diffraction patterns through single and double slits with adjustable wavelength.",
    category: "physics",
    subcategory: "optics",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/diffraction/",
    thumbnailEmoji: "🔦",
    tags: ["diffraction", "Fresnel", "slit", "wave optics"],
  },
  {
    id: "falstad-fermat",
    name: "Fermat's Principle (Snell's Law)",
    description:
      "See how light bends at an interface by finding the path of least time — deriving Snell's law from Fermat's principle.",
    category: "physics",
    subcategory: "optics",
    gradeLevel: "High School",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/fermat/",
    thumbnailEmoji: "💎",
    tags: ["refraction", "Snell", "Fermat", "optical path"],
  },

  // ==========================================================================
  //  FALSTAD — Electricity & Magnetism
  // ==========================================================================
  {
    id: "falstad-emstatic",
    name: "2D Electrostatics",
    description:
      "Place point charges and conductors in a 2D plane and watch electric field lines and equipotentials form.",
    category: "physics",
    subcategory: "electricity",
    gradeLevel: "High School",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/emstatic/index.html",
    thumbnailEmoji: "⚡",
    tags: ["electric field", "charge", "static", "Gauss"],
  },
  {
    id: "falstad-vector2de",
    name: "Electric Field Vectors (2D)",
    description:
      "Visualise electric field vectors from various charge configurations in two dimensions.",
    category: "physics",
    subcategory: "electricity",
    gradeLevel: "High School",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/vector2de/",
    thumbnailEmoji: "➡️",
    tags: ["electric field", "vector", "Gauss law"],
  },
  {
    id: "falstad-vector3de",
    name: "Electric Field Vectors (3D)",
    description:
      "Explore three-dimensional electric field patterns from charges, dipoles and capacitors.",
    category: "physics",
    subcategory: "electricity",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/vector3de/",
    thumbnailEmoji: "🧲",
    tags: ["electric field", "3D", "vector", "flux"],
  },
  {
    id: "falstad-vector3dm",
    name: "Magnetic Field Vectors (3D)",
    description:
      "Visualise 3D magnetic fields from current loops, solenoids and permanent magnets.",
    category: "physics",
    subcategory: "electricity",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/vector3dm/",
    thumbnailEmoji: "🧲",
    tags: ["magnetic field", "3D", "Ampere", "solenoid"],
  },
  {
    id: "falstad-emwave1",
    name: "Electromagnetic Waves (TE)",
    description:
      "See transverse-electric electromagnetic wave propagation, diffraction and antenna radiation.",
    category: "physics",
    subcategory: "electricity",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/emwave1/",
    thumbnailEmoji: "📡",
    tags: ["EM wave", "radiation", "antenna", "diffraction"],
  },
  {
    id: "falstad-emwave2",
    name: "Electromagnetic Waves (TM)",
    description:
      "Visualise transverse-magnetic EM waves, eddy currents and induction in conducting media.",
    category: "physics",
    subcategory: "electricity",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/emwave2/",
    thumbnailEmoji: "📻",
    tags: ["EM wave", "induction", "eddy current", "magnetostatics"],
  },
  {
    id: "falstad-circuit",
    name: "Circuit Simulator",
    description:
      "Build and simulate electronic circuits with resistors, capacitors, transistors, LEDs and more in real time.",
    category: "physics",
    subcategory: "electricity",
    gradeLevel: "High School",
    source: "Falstad",
    ...
    thumbnailEmoji: "🔌",
    tags: ["circuit", "resistor", "capacitor", "transistor", "LED"],
  },
  {
    id: "falstad-afilter",
    name: "Analog Filter Designer",
    description:
      "Design and visualise analog filters — low-pass, high-pass, band-pass — with Bode plots.",
    category: "physics",
    subcategory: "electricity",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/afilter/",
    thumbnailEmoji: "🎛️",
    tags: ["filter", "analog", "frequency", "low-pass", "high-pass"],
  },
  {
    id: "falstad-antenna",
    name: "Antenna Radiation Patterns",
    description:
      "Explore radiation patterns of dipoles, arrays and dish antennas in an interactive 3D viewer.",
    category: "physics",
    subcategory: "electricity",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/antenna/",
    thumbnailEmoji: "📡",
    tags: ["antenna", "radiation", "pattern", "dipole"],
  },
  {
    id: "falstad-motor",
    name: "Electric Motor",
    description:
      "See how a DC motor converts electrical energy into rotational motion using magnets and a commutator.",
    category: "physics",
    subcategory: "electricity",
    gradeLevel: "High School",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/motor/",
    thumbnailEmoji: "⚙️",
    tags: ["motor", "electric", "rotation", "magnetic"],
  },
  {
    id: "falstad-generator",
    name: "Electric Generator",
    description:
      "Spin a coil inside a magnetic field and watch how Faraday's law produces alternating current.",
    category: "physics",
    subcategory: "electricity",
    gradeLevel: "High School",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/generator/",
    thumbnailEmoji: "🔋",
    tags: ["generator", "electric", "induction", "Faraday"],
  },

  // ==========================================================================
  //  FALSTAD — Quantum Mechanics
  // ==========================================================================
  {
    id: "falstad-qmatom",
    name: "Hydrogen Atom Orbitals",
    description:
      "Visualise hydrogen atom wave functions and probability clouds for different quantum numbers.",
    category: "physics",
    subcategory: "atomic structure",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/qmatom/",
    thumbnailEmoji: "⚛️",
    tags: ["hydrogen", "orbital", "wave function", "quantum"],
  },
  {
    id: "falstad-qmmo",
    name: "Molecular Orbitals (H₂⁺)",
    description:
      "Explore bonding and antibonding molecular orbitals of the simplest molecule, H₂⁺.",
    category: "physics",
    subcategory: "atomic structure",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/qmmo/",
    thumbnailEmoji: "🔬",
    tags: ["molecular orbital", "hydrogen ion", "bonding"],
  },
  {
    id: "falstad-qm1d",
    name: "1D Quantum Mechanics",
    description:
      "Solve the 1D Schrödinger equation for various potentials and watch wave-function evolution.",
    category: "physics",
    subcategory: "atomic structure",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/qm1d/",
    thumbnailEmoji: "📉",
    tags: ["Schrödinger", "potential well", "quantum", "1D"],
  },
  {
    id: "falstad-qm2dosc",
    name: "2D Quantum Harmonic Oscillator",
    description:
      "Visualise energy eigenstates and superpositions of a 2D quantum harmonic oscillator.",
    category: "physics",
    subcategory: "atomic structure",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/qm2dosc/",
    thumbnailEmoji: "🎯",
    tags: ["harmonic oscillator", "quantum", "2D", "energy"],
  },

  // ==========================================================================
  //  FALSTAD — Mechanics & Thermodynamics
  // ==========================================================================
  {
    id: "falstad-gas",
    name: "Gas Molecules (Kinetic Theory)",
    description:
      "Watch gas molecules bounce around a container and see how temperature and pressure are related.",
    category: "physics",
    subcategory: "thermodynamics",
    gradeLevel: "High School",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/gas/",
    thumbnailEmoji: "💨",
    tags: ["gas", "kinetic theory", "molecules", "temperature", "pressure"],
  },
  {
    id: "falstad-engine",
    name: "Heat Engine Cycles",
    description:
      "Explore Carnot, Otto, Diesel and other thermodynamic cycles on a PV diagram.",
    category: "physics",
    subcategory: "thermodynamics",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/engine/",
    thumbnailEmoji: "🏭",
    tags: ["Carnot", "heat engine", "thermodynamic cycle", "PV diagram"],
  },
  {
    id: "falstad-harmonicosc",
    name: "Harmonic Oscillator",
    description:
      "Drive a spring-mass system at various frequencies and see resonance, damping and transient behaviour.",
    category: "physics",
    subcategory: "mechanics",
    gradeLevel: "High School",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/harmonicosc/",
    thumbnailEmoji: "🔄",
    tags: ["oscillator", "resonance", "driving force", "damping"],
  },
  {
    id: "falstad-coriolis",
    name: "Coriolis Force",
    description:
      "Launch projectiles in a rotating reference frame and observe the Coriolis deflection first-hand.",
    category: "physics",
    subcategory: "mechanics",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/coriolis/",
    thumbnailEmoji: "🌀",
    tags: ["Coriolis", "rotating frame", "inertial", "Earth"],
  },
  {
    id: "falstad-lagrange",
    name: "Lagrange Points",
    description:
      "Find and explore the five Lagrange points in the Sun-Earth (or any two-body) gravitational system.",
    category: "physics",
    subcategory: "mechanics",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/lagrange/",
    thumbnailEmoji: "🪐",
    tags: ["Lagrange", "three-body", "orbit", "gravity"],
  },
  ...
  // ==========================================================================
  {
    id: "falstad-dotproduct",
    name: "Dot Product Visualizer",
    description:
      "Drag two vectors and see how the dot product relates to their angle and magnitudes.",
    category: "math",
    subcategory: "linear algebra",
    gradeLevel: "High School",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/dotproduct/",
    thumbnailEmoji: "📐",
    tags: ["dot product", "scalar", "vector", "angle"],
  },
  {
    id: "falstad-matrix",
    name: "Matrix Transformations (2D)",
    description:
      "Apply 2×2 matrices to shapes and watch rotations, reflections, shears and scaling in real time.",
    category: "math",
    subcategory: "linear algebra",
    gradeLevel: "High School",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/matrix/",
    thumbnailEmoji: "🔢",
    tags: ["matrix", "transformation", "linear", "2D"],
  },
  {
    id: "falstad-vector",
    name: "2D Vector Fields",
    description:
      "Plot and interact with 2D vector fields — see divergence, curl, streamlines and flow patterns.",
    category: "math",
    subcategory: "calculus",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/vector/",
    thumbnailEmoji: "↗️",
    tags: ["vector field", "divergence", "curl", "gradient"],
  },
  {
    id: "falstad-vector3d",
    name: "3D Vector Fields",
    description:
      "Explore 3D vector fields including the Lorenz attractor, electric dipoles and fluid flows.",
    category: "math",
    subcategory: "calculus",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/vector3d/",
    thumbnailEmoji: "🌐",
    tags: ["vector field", "3D", "Lorenz attractor", "flow"],
  },
  {
    id: "falstad-diffeq",
    name: "ODE Visualizer",
    description:
      "Draw slope fields and solution curves for first- and second-order ordinary differential equations.",
    category: "math",
    subcategory: "calculus",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/diffeq/",
    thumbnailEmoji: "📈",
    tags: ["differential equation", "ODE", "slope field", "solution"],
  },
  {
    id: "falstad-fft",
    name: "2D Fourier Transform",
    description:
      "Apply a 2D discrete Fourier transform to images and see how spatial frequencies build pictures.",
    category: "math",
    subcategory: "calculus",
    gradeLevel: "College",
    source: "Falstad",
    embedUrl: "https://www.falstad.com/fft/",
    thumbnailEmoji: "🖼️",
    tags: ["Fourier transform", "DFT", "frequency", "2D"],
  },
  ...
  // ==========================================================================
  {
    ...
    name: "Song Maker",
    description:
      "Compose melodies and rhythms by painting notes on a grid — great for learning music basics.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "Middle School",
    source: "Chrome Music Lab",
    embedUrl: "https://musiclab.chromeexperiments.com/Song-Maker/",
    thumbnailEmoji: "🎵",
    tags: ["music", "rhythm", "melody", "compose", "create"],
  },
  {
    id: "cml-rhythm",
    name: "Rhythm",
    description:
      "Tap out drum patterns and explore how different rhythms combine into grooves.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "Middle School",
    source: "Chrome Music Lab",
    embedUrl: "https://musiclab.chromeexperiments.com/Rhythm/",
    thumbnailEmoji: "🥁",
    tags: ["rhythm", "beat", "percussion", "pattern"],
  },
  {
    id: "cml-spectrogram",
    name: "Spectrogram",
    description:
      "See a live spectrogram of sounds from your microphone — visualise frequency and time together.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "Middle School",
    source: "Chrome Music Lab",
    embedUrl: "https://musiclab.chromeexperiments.com/Spectrogram/",
    thumbnailEmoji: "📊",
    tags: ["spectrogram", "frequency", "sound", "visualization"],
  },
  {
    id: "cml-chords",
    name: "Chords",
    description:
      "Play major and minor chords and hear how combining notes creates harmony.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "Middle School",
    source: "Chrome Music Lab",
    embedUrl: "https://musiclab.chromeexperiments.com/Chords/",
    thumbnailEmoji: "🎹",
    tags: ["chords", "harmony", "major", "minor"],
  },
  {
    id: "cml-sound-waves",
    name: "Sound Waves",
    description:
      "Watch how sound waves travel through air by vibrating molecules back and forth.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "Middle School",
    source: "Chrome Music Lab",
    embedUrl: "https://musiclab.chromeexperiments.com/Sound-Waves/",
    thumbnailEmoji: "🔊",
    tags: ["sound wave", "vibration", "frequency", "air molecules"],
  },
  {
    id: "cml-arpeggios",
    name: "Arpeggios",
    description:
      "Hear what happens when chord notes are played one after another in different patterns.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "Middle School",
    source: "Chrome Music Lab",
    embedUrl: "https://musiclab.chromeexperiments.com/Arpeggios/",
    thumbnailEmoji: "🎶",
    tags: ["arpeggio", "chord", "notes", "pattern"],
  },
  {
    id: "cml-kandinsky",
    name: "Kandinsky (Art + Sound)",
    description:
      "Draw shapes on a canvas and hear them turned into music — art meets sound.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "Middle School",
    source: "Chrome Music Lab",
    embedUrl: "https://musiclab.chromeexperiments.com/Kandinsky/",
    thumbnailEmoji: "🎨",
    tags: ["art", "sound", "drawing", "Kandinsky", "visual music"],
  },
  {
    id: "cml-melody-maker",
    name: "Melody Maker",
    description:
      "Create simple melodies by placing notes on a timeline — perfect for young composers.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "Middle School",
    source: "Chrome Music Lab",
    embedUrl: "https://musiclab.chromeexperiments.com/Melody-Maker/",
    thumbnailEmoji: "🎼",
    tags: ["melody", "compose", "notes", "music"],
  },
  {
    id: "cml-voice-spinner",
    name: "Voice Spinner",
    description:
      "Record your voice and spin it to change pitch and speed — explore frequency and playback.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "Middle School",
    source: "Chrome Music Lab",
    embedUrl: "https://musiclab.chromeexperiments.com/Voice-Spinner/",
    thumbnailEmoji: "🗣️",
    tags: ["voice", "frequency", "pitch", "speed", "record"],
  },
  {
    id: "cml-harmonics",
    name: "Harmonics",
    description:
      "See and hear the harmonic series — the natural overtones that give instruments their timbre.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "Middle School",
    source: "Chrome Music Lab",
    embedUrl: "https://musiclab.chromeexperiments.com/Harmonics/",
    thumbnailEmoji: "🎻",
    tags: ["harmonics", "overtone", "frequency", "series"],
  },
  {
    id: "cml-piano-roll",
    name: "Piano Roll",
    description:
      "Watch classical pieces by Bach, Mozart and others scroll by on a piano roll visualisation.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "Middle School",
    source: "Chrome Music Lab",
    embedUrl: "https://musiclab.chromeexperiments.com/Piano-Roll/",
    thumbnailEmoji: "🎹",
    tags: ["piano roll", "classical", "Bach", "Mozart", "music"],
  },
  {
    id: "cml-oscillators",
    name: "Oscillators",
    description:
      "Compare sine, square, sawtooth and triangle waveforms — the building blocks of electronic sound.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "Middle School",
    source: "Chrome Music Lab",
    embedUrl: "https://musiclab.chromeexperiments.com/Oscillators/",
    thumbnailEmoji: "〰️",
    tags: ["oscillator", "sine", "square", "sawtooth", "waveform"],
  },
  {
    id: "cml-strings",
    name: "Strings",
    description:
      "Pluck virtual strings of different lengths and hear how shorter strings produce higher pitches.",
    category: "physics",
    subcategory: "waves",
    gradeLevel: "Middle School",
    source: "Chrome Music Lab",
    embedUrl: "https://musiclab.chromeexperiments.com/Strings/",
    thumbnailEmoji: "🎸",
    tags: ["string", "vibration", "length", "pitch", "frequency"],
  },
  ...
  // ==========================================================================
  {
    ...
    description:
      "A game-theory simulation about why and how trust between strangers rises and falls.",
    category: "math",
    subcategory: "statistics",
    gradeLevel: "High School",
    source: "Nicky Case",
    embedUrl: "https://ncase.me/trust/",
    thumbnailEmoji: "🤝",
    tags: ["game theory", "trust", "cooperation", "prisoner dilemma"],
  },
  {
    id: "ncase-polygons",
    name: "Parable of the Polygons",
    description:
      "A playable story about how small individual biases can lead to large-scale segregation.",
    category: "math",
    subcategory: "statistics",
    gradeLevel: "Middle School",
    source: "Nicky Case",
    embedUrl: "https://ncase.me/polygons/",
    thumbnailEmoji: "🔷",
    tags: ["segregation", "bias", "diversity", "Schelling"],
  },
  {
    id: "ncase-fireflies",
    name: "Fireflies (Sync Simulation)",
    description:
      "Watch fireflies synchronise their flashing — a beautiful example of emergent behaviour.",
    category: "biology",
    subcategory: "ecology",
    gradeLevel: "Middle School",
    source: "Nicky Case",
    embedUrl: "https://ncase.me/fireflies/",
    thumbnailEmoji: "✨",
    tags: ["synchronization", "fireflies", "emergence", "oscillation"],
  },
  {
    id: "ncase-loopy",
    name: "Loopy (Systems Thinking)",
    description:
      "Draw causal loops to model systems — explore feedback, delay and unintended consequences.",
    category: "engineering",
    subcategory: "mechanical",
    gradeLevel: "Middle School",
    source: "Nicky Case",
    embedUrl: "https://ncase.me/loopy/",
    thumbnailEmoji: "🔁",
    tags: ["systems thinking", "feedback", "loop", "cause effect"],
  },
  {
    id: "ncase-crowds",
    name: "Wisdom/Madness of Crowds",
    description:
      "Explore how network structure shapes whether crowds become wise or mad.",
    category: "math",
    subcategory: "statistics",
    gradeLevel: "High School",
    source: "Nicky Case",
    embedUrl: "https://ncase.me/crowds/",
    thumbnailEmoji: "👥",
    tags: ["networks", "crowd", "social", "connection", "influence"],
  },
  {
    id: "ncase-ballot",
    name: "To Build a Better Ballot",
    description:
      "Compare voting systems — plurality, ranked, approval — and see which ones actually represent the people.",
    category: "math",
    subcategory: "statistics",
    gradeLevel: "High School",
    source: "Nicky Case",
    embedUrl: "https://ncase.me/ballot/",
    thumbnailEmoji: "🗳️",
    tags: ["voting", "election", "ballot", "democracy", "system"],
  },
  {
    id: "ncase-neurons",
    name: "Neurotic Neurons",
    description:
      "An interactive explanation of neurons, Hebbian learning and how anxiety works in the brain.",
    category: "biology",
    subcategory: "neuroscience",
    gradeLevel: "High School",
    source: "Nicky Case",
    embedUrl: "https://ncase.me/neurons/",
    thumbnailEmoji: "🧠",
    tags: ["neuron", "anxiety", "Hebbian", "brain", "learning"],
  },
  ...
  {
    id: "stellarium-web",
    name: "Stellarium Web (Interactive Sky Map)",
    description:
      "A full planetarium in your browser — explore stars, constellations and planets from any place and time.",
    category: "earth-science",
    subcategory: "astronomy",
    gradeLevel: "Middle School",
    source: "Other",
    ...
    thumbnailEmoji: "🌌",
    tags: ["stars", "constellations", "planets", "sky", "planetarium", "night sky"],
  },

  // ==========================================================================
  //  BIOLOGY EXPANSION — Higher Secondary Curriculum
  //  Anatomy · Cell Biology · Physiology · Genetics · Plant · Microbiology
  // ==========================================================================

  // ----- Cell Biology: Structure & Organelles --------------------------------
  {
    id: "bio-x-cell-inside",
    name: "Inside a Cell — Organelle Tour",
    description:
      "Click through every organelle inside an animal cell. Discover what the nucleus, mitochondria, ribosomes, ER, Golgi, lysosomes and cytoskeleton actually do, with real microscopy images alongside.",
    category: "biology",
    subcategory: "cell biology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/cells/insideacell/",
    thumbnailEmoji: "🧫",
    tags: ["cell", "organelle", "nucleus", "mitochondria", "ribosome", "ER", "golgi", "anatomy"],
  },
  {
    id: "bio-x-cell-membrane",
    name: "The Cell Membrane — Phospholipid Bilayer",
    description:
      "See how the phospholipid bilayer keeps a cell alive. Watch hydrophilic heads face water and hydrophobic tails hide inside, and learn how proteins, cholesterol and channels make the membrane selectively permeable.",
    category: "biology",
    subcategory: "cell biology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/cells/membranes/",
    thumbnailEmoji: "🧱",
    tags: ["membrane", "phospholipid", "bilayer", "channel", "transport", "cell"],
  },
  {
    id: "bio-x-osmosis-tonicity",
    name: "Osmosis & Tonicity",
    description:
      "Drop a cell into hypertonic, isotonic or hypotonic solution and watch it shrink, stay normal, or burst. The same demo behind why drinking seawater dehydrates you and why IV fluids must be isotonic.",
    category: "biology",
    subcategory: "cell biology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("diffusion"),
    thumbnailEmoji: "🩸",
    tags: ["osmosis", "tonicity", "hypertonic", "hypotonic", "isotonic", "membrane", "water"],
  },
  {
    id: "bio-x-active-vs-passive",
    name: "Active vs Passive Transport",
    description:
      "Compare diffusion, facilitated diffusion, and ATP-powered active transport across the cell membrane. Learn why moving glucose into a cell can be free, while pumping sodium out costs energy.",
    category: "biology",
    subcategory: "cell biology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("concentration"),
    thumbnailEmoji: "🚪",
    tags: ["active transport", "passive transport", "ATP", "sodium-potassium pump", "facilitated diffusion"],
  },
  {
    id: "bio-x-mitosis",
    name: "Mitosis — How Cells Divide",
    description:
      "Step through prophase, metaphase, anaphase, telophase and cytokinesis. See chromosomes condense, line up, separate, and produce two genetically identical daughter cells — the basis of growth and tissue repair.",
    category: "biology",
    subcategory: "cell biology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/basics/cellcycle/",
    thumbnailEmoji: "🧬",
    tags: ["mitosis", "cell division", "chromosome", "prophase", "metaphase", "anaphase", "telophase"],
  },
  {
    id: "bio-x-meiosis",
    name: "Meiosis — Making Gametes",
    description:
      "Follow a single diploid cell through meiosis I and II to produce four genetically unique haploid gametes. Watch homologous pairs cross over and segregate — the source of genetic variation.",
    category: "biology",
    subcategory: "cell biology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/inheritance/snurfle/",
    thumbnailEmoji: "🧪",
    tags: ["meiosis", "gamete", "haploid", "diploid", "crossing over", "variation"],
  },
  {
    id: "bio-x-cell-cycle",
    name: "The Cell Cycle & Checkpoints",
    description:
      "Follow a cell through G1, S, G2 and M phases. See the role of cyclins and CDKs at the checkpoints, and learn what happens when those checkpoints fail — the link to cancer.",
    category: "biology",
    subcategory: "cell biology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/basics/cellcycle/",
    thumbnailEmoji: "🔄",
    tags: ["cell cycle", "G1", "S phase", "G2", "mitosis", "checkpoint", "cyclin", "cancer"],
  },
  {
    id: "bio-x-photosynthesis",
    name: "Photosynthesis — Light & Calvin Cycle",
    description:
      "Track light energy from a chloroplast's thylakoid membrane through photosystems II and I, ATP and NADPH formation, and into the Calvin cycle that fixes CO₂ into glucose. The reaction that powers nearly all life.",
    category: "biology",
    subcategory: "cell biology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://www.biologysimulations.com/photosynthesis-1",
    thumbnailEmoji: "🌱",
    tags: ["photosynthesis", "chloroplast", "thylakoid", "calvin cycle", "ATP", "NADPH", "glucose"],
  },
  {
    id: "bio-x-cellular-respiration",
    name: "Cellular Respiration — ATP from Glucose",
    description:
      "Walk through glycolysis, the Krebs (citric acid) cycle, and the electron transport chain. See how one glucose molecule produces ~30 ATP and why oxygen is essential for the final electron acceptor.",
    category: "biology",
    subcategory: "cell biology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://www.biologysimulations.com/cellular-respiration",
    thumbnailEmoji: "⚡",
    tags: ["cellular respiration", "glycolysis", "krebs cycle", "electron transport chain", "ATP", "mitochondria"],
  },
  {
    id: "bio-x-enzymes",
    name: "Enzymes — Substrate, Active Site, pH",
    description:
      "Test how temperature, pH, and substrate concentration affect enzyme activity. See the lock-and-key model, induced fit, and why fever or stomach acid changes how your enzymes work.",
    category: "biology",
    subcategory: "biochemistry",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://www.biologysimulations.com/enzymes",
    thumbnailEmoji: "🔧",
    tags: ["enzyme", "active site", "substrate", "lock and key", "induced fit", "denaturation", "pH"],
  },
  {
    id: "bio-x-mitochondria",
    name: "Mitochondria — The Powerhouse",
    description:
      "Explore the inner and outer mitochondrial membranes, cristae, and matrix. See how the proton gradient drives ATP synthase to produce energy currency for every cell in your body.",
    category: "biology",
    subcategory: "cell biology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("energy-forms-and-changes"),
    thumbnailEmoji: "🔋",
    tags: ["mitochondria", "ATP synthase", "cristae", "proton gradient", "chemiosmosis"],
  },

  // ----- Anatomy: Skeletal & Muscular ----------------------------------------
  {
    id: "bio-x-skeletal-system",
    name: "Skeletal System — 206 Bones",
    description:
      "Tour the human skeleton: skull, vertebral column, rib cage, pelvis, and the long, short, flat and irregular bones of the limbs. Learn the function of each major bone and how the skeleton supports, protects and moves the body.",
    category: "biology",
    subcategory: "anatomy",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://human.biodigital.com/viewer/?id=production/maleAdult/skeletal_system_kids",
    thumbnailEmoji: "🦴",
    tags: ["skeleton", "bone", "skull", "vertebra", "femur", "anatomy", "musculoskeletal"],
  },
  {
    id: "bio-x-bone-structure",
    name: "Bone Structure — Compact & Spongy",
    description:
      "Zoom into a long bone and see compact bone, spongy bone, marrow, periosteum and Haversian canals. Learn how osteoblasts build bone and osteoclasts break it down — the constant remodeling that keeps your skeleton alive.",
    category: "biology",
    subcategory: "anatomy",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("density"),
    thumbnailEmoji: "🦴",
    tags: ["bone", "compact", "spongy", "marrow", "osteoblast", "osteoclast", "haversian"],
  },
  {
    id: "bio-x-joints",
    name: "Joints & Range of Motion",
    description:
      "Compare hinge, ball-and-socket, pivot, gliding, saddle and condyloid joints. See why your knee bends one way but your shoulder rotates freely, and learn what cartilage and synovial fluid do.",
    category: "biology",
    subcategory: "anatomy",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("hookes-law"),
    thumbnailEmoji: "🦵",
    tags: ["joint", "hinge", "ball and socket", "synovial", "cartilage", "ligament", "anatomy"],
  },
  {
    id: "bio-x-muscle-types",
    name: "Three Muscle Types — Skeletal, Smooth, Cardiac",
    description:
      "Compare voluntary skeletal muscle, involuntary smooth muscle in your gut and blood vessels, and the unique striated cardiac muscle of your heart. Identify each under a microscope.",
    category: "biology",
    subcategory: "anatomy",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/cells/scale/",
    thumbnailEmoji: "💪",
    tags: ["muscle", "skeletal", "smooth", "cardiac", "striated", "voluntary", "involuntary"],
  },
  {
    id: "bio-x-muscle-contraction",
    name: "Muscle Contraction — Sliding Filament",
    description:
      "Watch actin and myosin filaments slide past each other inside a sarcomere. See how Ca²⁺ release, ATP, and the troponin–tropomyosin switch let you flex a finger or sprint a hundred metres.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("forces-and-motion-basics"),
    thumbnailEmoji: "🏋️",
    tags: ["muscle contraction", "actin", "myosin", "sliding filament", "sarcomere", "ATP", "calcium"],
  },

  // ----- Anatomy: Circulatory & Cardiovascular -------------------------------
  {
    id: "bio-x-heart-anatomy",
    name: "Heart Anatomy — Four Chambers",
    description:
      "Explore the right atrium, right ventricle, left atrium and left ventricle. Trace blood through the tricuspid, pulmonary, mitral and aortic valves and understand the lub-dub of every heartbeat.",
    category: "biology",
    subcategory: "anatomy",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://www.biologysimulations.com/circulatory-system",
    thumbnailEmoji: "❤️",
    tags: ["heart", "atrium", "ventricle", "valve", "aorta", "cardiac", "anatomy"],
  },
  {
    id: "bio-x-blood-circulation",
    name: "Pulmonary & Systemic Circulation",
    description:
      "Follow a red blood cell through the pulmonary loop (heart → lungs → heart) and systemic loop (heart → body → heart). Understand why we say the heart is really two pumps in one.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("fluid-pressure-and-flow"),
    thumbnailEmoji: "🩸",
    tags: ["circulation", "pulmonary", "systemic", "blood flow", "vena cava", "aorta"],
  },
  {
    id: "bio-x-blood-components",
    name: "Blood — RBCs, WBCs, Platelets, Plasma",
    description:
      "Look inside a drop of blood. See red blood cells carrying oxygen via hemoglobin, white blood cells defending against pathogens, platelets clotting wounds, and plasma transporting everything.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/cells/scale/",
    thumbnailEmoji: "🩸",
    tags: ["blood", "RBC", "erythrocyte", "WBC", "leukocyte", "platelet", "plasma", "hemoglobin"],
  },
  {
    id: "bio-x-blood-pressure",
    name: "Blood Pressure & Vessel Resistance",
    description:
      "Adjust vessel diameter and pump strength to see how blood pressure responds. Connects directly to systolic/diastolic readings, hypertension, and why narrowed arteries are dangerous.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("fluid-pressure-and-flow"),
    thumbnailEmoji: "🫀",
    tags: ["blood pressure", "systolic", "diastolic", "hypertension", "resistance", "artery"],
  },
  {
    id: "bio-x-blood-types",
    name: "ABO Blood Types & Transfusion",
    description:
      "Mix donor and recipient blood and see when antigens and antibodies clump. Learn why type O is the universal donor, AB is the universal recipient, and why mismatched transfusions are fatal.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/inheritance/blood/",
    thumbnailEmoji: "🩹",
    tags: ["blood type", "ABO", "Rh", "antigen", "antibody", "transfusion", "agglutination"],
  },

  // ----- Anatomy: Respiratory ------------------------------------------------
  {
    id: "bio-x-respiratory-system",
    name: "Respiratory System — Nose to Alveoli",
    description:
      "Trace a breath from nostril through pharynx, larynx, trachea, bronchi and bronchioles down to the alveoli. See how 300 million tiny air sacs give the lungs the surface area of a tennis court.",
    category: "biology",
    subcategory: "anatomy",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://www.biologysimulations.com/respiratory-system",
    thumbnailEmoji: "🫁",
    tags: ["lungs", "alveoli", "trachea", "bronchi", "respiratory", "breathing"],
  },
  {
    id: "bio-x-breathing-mechanics",
    name: "Breathing Mechanics — Diaphragm & Pressure",
    description:
      "Watch the diaphragm contract and the rib cage expand. Boyle's law in action: increasing chest volume drops pressure, pulling air in. The exact physics behind every breath you take.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("under-pressure"),
    thumbnailEmoji: "🌬️",
    tags: ["breathing", "diaphragm", "inhalation", "exhalation", "Boyle's law", "thoracic pressure"],
  },
  {
    id: "bio-x-gas-exchange",
    name: "Gas Exchange — O₂ in, CO₂ out",
    description:
      "Zoom into an alveolus and see oxygen diffuse into capillaries while CO₂ diffuses out. Driven entirely by partial pressure differences — the same physics as gas-properties but in your lungs.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("gas-properties"),
    thumbnailEmoji: "🫁",
    tags: ["gas exchange", "alveolus", "diffusion", "partial pressure", "oxygen", "carbon dioxide"],
  },

  // ----- Anatomy: Digestive --------------------------------------------------
  {
    id: "bio-x-digestive-system",
    name: "Digestive System — Mouth to Anus",
    description:
      "Follow a meal through the mouth, esophagus, stomach, small intestine, large intestine, and out. Learn what each accessory organ — liver, pancreas, gallbladder — adds to the journey.",
    category: "biology",
    subcategory: "anatomy",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://www.biologysimulations.com/digestive-system",
    thumbnailEmoji: "🍽️",
    tags: ["digestion", "stomach", "intestine", "liver", "pancreas", "esophagus", "anatomy"],
  },
  {
    id: "bio-x-digestion-enzymes",
    name: "Digestive Enzymes — Amylase to Lipase",
    description:
      "Match each enzyme to its substrate: salivary amylase on starch, pepsin on protein in the acidic stomach, lipase on fats in the small intestine. See why each works only in its own pH zone.",
    category: "biology",
    subcategory: "biochemistry",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("ph-scale"),
    thumbnailEmoji: "🧪",
    tags: ["amylase", "pepsin", "lipase", "trypsin", "enzyme", "digestion", "pH"],
  },
  {
    id: "bio-x-villi-absorption",
    name: "Villi — Surface Area for Absorption",
    description:
      "See why the small intestine has fingerlike villi covered in microvilli — multiplying surface area 600-fold. Learn how nutrients cross the brush border into capillaries and lacteals.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("diffusion"),
    thumbnailEmoji: "🌾",
    tags: ["villi", "microvilli", "absorption", "small intestine", "surface area", "brush border"],
  },

  // ----- Anatomy: Excretory --------------------------------------------------
  {
    id: "bio-x-kidney-anatomy",
    name: "Kidney Anatomy — Cortex, Medulla, Nephron",
    description:
      "Slice into a kidney and see the cortex, medulla, renal pyramids, and pelvis. Zoom into a single nephron — the million-times-repeated filtering unit that cleans 180 L of blood every day.",
    category: "biology",
    subcategory: "anatomy",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://www.biologysimulations.com/excretory-system",
    thumbnailEmoji: "🫘",
    tags: ["kidney", "nephron", "cortex", "medulla", "glomerulus", "anatomy", "excretion"],
  },
  {
    id: "bio-x-nephron-filtration",
    name: "Nephron — Filtration, Reabsorption, Secretion",
    description:
      "Walk through Bowman's capsule, proximal tubule, loop of Henle, distal tubule and collecting duct. See exactly what gets filtered, what's reabsorbed, and what becomes urine.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("concentration"),
    thumbnailEmoji: "💧",
    tags: ["nephron", "glomerulus", "Bowman's capsule", "loop of Henle", "filtration", "reabsorption"],
  },

  // ----- Anatomy: Nervous System ---------------------------------------------
  {
    id: "bio-x-nervous-system",
    name: "Nervous System — CNS & PNS",
    description:
      "Map the central nervous system (brain, spinal cord) and the peripheral nervous system (somatic, autonomic, sympathetic, parasympathetic). Understand who controls what — heartbeat vs handshake.",
    category: "biology",
    subcategory: "anatomy",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://www.biologysimulations.com/nervous-system",
    thumbnailEmoji: "🧠",
    tags: ["nervous system", "CNS", "PNS", "sympathetic", "parasympathetic", "autonomic"],
  },
  {
    id: "bio-x-brain-regions",
    name: "Human Brain — Lobes & Function",
    description:
      "Tour the frontal, parietal, temporal and occipital lobes, plus the cerebellum, brainstem, hippocampus and amygdala. Learn which regions plan, see, hear, balance, remember and feel fear.",
    category: "biology",
    subcategory: "anatomy",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/addiction/brain/",
    thumbnailEmoji: "🧠",
    tags: ["brain", "frontal lobe", "cerebellum", "hippocampus", "amygdala", "neuroscience", "lobes"],
  },
  {
    id: "bio-x-neuron-anatomy",
    name: "Neuron Anatomy — Dendrite, Axon, Synapse",
    description:
      "Identify the soma, dendrites, axon hillock, axon, myelin sheath, nodes of Ranvier, and synaptic terminals. The basic wiring diagram of every nerve cell in your body.",
    category: "biology",
    subcategory: "anatomy",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("neuron"),
    thumbnailEmoji: "🧠",
    tags: ["neuron", "dendrite", "axon", "myelin", "synapse", "soma", "anatomy"],
  },
  {
    id: "bio-x-action-potential",
    name: "Action Potential — Step by Step",
    description:
      "Open and close Na⁺ and K⁺ channels by hand and watch a -70 mV resting potential leap to +30 mV and back. Understand depolarization, repolarization, and the absolute refractory period.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("neuron"),
    thumbnailEmoji: "⚡",
    tags: ["action potential", "depolarization", "repolarization", "sodium", "potassium", "membrane potential"],
  },
  {
    id: "bio-x-synaptic-transmission",
    name: "Synaptic Transmission — Neurotransmitters",
    description:
      "Trigger a presynaptic vesicle release. Watch neurotransmitters cross the synaptic cleft, bind to postsynaptic receptors, and either excite or inhibit the next cell.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/addiction/mouse/",
    thumbnailEmoji: "🔗",
    tags: ["synapse", "neurotransmitter", "vesicle", "receptor", "EPSP", "IPSP", "dopamine"],
  },
  {
    id: "bio-x-reflex-arc",
    name: "Reflex Arc — Knee Jerk in 50 ms",
    description:
      "Tap the patellar tendon and trace the impulse: receptor → sensory neuron → spinal cord → motor neuron → muscle. See why reflexes bypass the brain entirely.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("neuron"),
    thumbnailEmoji: "🦵",
    tags: ["reflex", "spinal cord", "sensory neuron", "motor neuron", "knee jerk", "patellar"],
  },

  // ----- Anatomy: Sensory Organs ---------------------------------------------
  {
    id: "bio-x-eye-anatomy",
    name: "Eye Anatomy — Cornea to Retina",
    description:
      "Identify the cornea, iris, pupil, lens, vitreous humour, retina, fovea, and optic nerve. See how light is bent and focused, and where rod and cone photoreceptors actually sit.",
    category: "biology",
    subcategory: "anatomy",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("bending-light"),
    thumbnailEmoji: "👁️",
    tags: ["eye", "cornea", "lens", "retina", "rod", "cone", "fovea", "optic nerve"],
  },
  {
    id: "bio-x-vision-defects",
    name: "Vision Defects — Myopia, Hyperopia, Astigmatism",
    description:
      "Move the focal point in front of or behind the retina to model nearsightedness and farsightedness. Add a corrective concave or convex lens and watch the image snap back to clear.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("geometric-optics"),
    thumbnailEmoji: "👓",
    tags: ["myopia", "hyperopia", "astigmatism", "lens", "vision", "correction", "eye"],
  },
  {
    id: "bio-x-color-perception",
    name: "Color Vision — Three Cones",
    description:
      "Mix red, green, and blue cone signals to perceive every visible color. Discover what color blindness actually means and why monitors only need three colors.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("color-vision"),
    thumbnailEmoji: "🌈",
    tags: ["color vision", "cone", "trichromacy", "color blindness", "RGB", "perception"],
  },
  {
    id: "bio-x-ear-anatomy",
    name: "Ear Anatomy — Outer, Middle, Inner",
    description:
      "Trace sound from the pinna through the auditory canal, eardrum, ossicles (hammer-anvil-stirrup), cochlea, and on to the auditory nerve. See where balance lives in the semicircular canals.",
    category: "biology",
    subcategory: "anatomy",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("wave-on-a-string"),
    thumbnailEmoji: "👂",
    tags: ["ear", "cochlea", "ossicles", "eardrum", "tympanic membrane", "hearing", "anatomy"],
  },
  {
    id: "bio-x-hearing-frequency",
    name: "How We Hear — Frequency to Pitch",
    description:
      "Vary frequency from 20 Hz to 20 kHz and see which hair cells in the cochlea fire. Understand why the basilar membrane separates pitches like a piano keyboard along its length.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("waves-intro"),
    thumbnailEmoji: "🔊",
    tags: ["hearing", "frequency", "pitch", "cochlea", "basilar membrane", "hair cell"],
  },

  // ----- Anatomy: Endocrine --------------------------------------------------
  {
    id: "bio-x-endocrine-system",
    name: "Endocrine System — Glands & Hormones",
    description:
      "Locate the pituitary, thyroid, parathyroid, adrenal, pancreas, pineal, ovaries and testes. Match each gland to the hormone it secretes and the body process it controls.",
    category: "biology",
    subcategory: "anatomy",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://www.biologysimulations.com/endocrine-system",
    thumbnailEmoji: "🧫",
    tags: ["endocrine", "hormone", "pituitary", "thyroid", "adrenal", "pancreas", "gland"],
  },
  {
    id: "bio-x-insulin-glucose",
    name: "Insulin & Blood Glucose Regulation",
    description:
      "Eat a meal and watch blood sugar spike. Insulin (from beta cells) drives uptake; glucagon (from alpha cells) reverses it. The exact loop that breaks in type 1 and type 2 diabetes.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("concentration"),
    thumbnailEmoji: "🍬",
    tags: ["insulin", "glucagon", "glucose", "diabetes", "pancreas", "homeostasis", "feedback"],
  },
  {
    id: "bio-x-feedback-loops",
    name: "Negative Feedback — Body Temperature",
    description:
      "Push body temperature off 37 °C and see thermoreceptors, the hypothalamus, sweat glands, and shivering all kick in to bring it back. The classic example of homeostasis.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("energy-forms-and-changes"),
    thumbnailEmoji: "🌡️",
    tags: ["homeostasis", "negative feedback", "thermoregulation", "hypothalamus", "set point"],
  },

  // ----- Anatomy: Reproductive -----------------------------------------------
  {
    id: "bio-x-reproductive-system",
    name: "Reproductive Systems — Male & Female",
    description:
      "Compare ovaries, fallopian tubes, uterus, vagina with testes, vas deferens, prostate, urethra. Track the production of gametes and the path of fertilization.",
    category: "biology",
    subcategory: "anatomy",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://www.biologysimulations.com/reproductive-system",
    thumbnailEmoji: "🧬",
    tags: ["reproductive", "ovary", "uterus", "testis", "gamete", "anatomy"],
  },
  {
    id: "bio-x-menstrual-cycle",
    name: "Menstrual Cycle — 28-Day Hormones",
    description:
      "Plot FSH, LH, estrogen, and progesterone over a single cycle. See follicular phase, ovulation, luteal phase and menstruation, and understand how birth control disrupts the loop.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("waves-intro"),
    thumbnailEmoji: "📅",
    tags: ["menstrual cycle", "FSH", "LH", "estrogen", "progesterone", "ovulation"],
  },
  {
    id: "bio-x-fertilization-embryo",
    name: "Fertilization to Blastocyst",
    description:
      "Follow the journey from sperm-egg fusion through cleavage, morula, blastocyst, implantation, and the first weeks of embryonic development.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/basics/cellcycle/",
    thumbnailEmoji: "👶",
    tags: ["fertilization", "zygote", "cleavage", "blastocyst", "implantation", "embryo"],
  },

  // ----- Anatomy: Immune & Lymphatic -----------------------------------------
  {
    id: "bio-x-immune-system",
    name: "Immune System — Innate & Adaptive",
    description:
      "Compare the fast, non-specific innate response (skin, macrophages, fever) with the slower, specific adaptive response (B cells, T cells, antibodies). Trace what happens when a pathogen invades.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://www.biologysimulations.com/immune-system",
    thumbnailEmoji: "🛡️",
    tags: ["immune", "innate", "adaptive", "B cell", "T cell", "antibody", "macrophage"],
  },
  {
    id: "bio-x-antibody-antigen",
    name: "Antibodies & Antigens",
    description:
      "See the Y-shaped antibody bind to its specific antigen at the variable region. Learn about IgG, IgM, IgA classes and why each vaccine produces a different immune memory.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://www.3dmol.org/",
    thumbnailEmoji: "🦠",
    tags: ["antibody", "antigen", "IgG", "IgM", "B cell", "vaccine", "immunoglobulin"],
  },
  {
    id: "bio-x-vaccines",
    name: "How Vaccines Work",
    description:
      "Inject a weakened or piece of a pathogen and watch B cells produce antibodies and memory cells. The next time the real pathogen arrives, the response is fast enough to prevent disease.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/basics/cellcycle/",
    thumbnailEmoji: "💉",
    tags: ["vaccine", "immunity", "memory cell", "antibody", "B cell", "immunization"],
  },

  // ----- Genetics & Molecular Biology ----------------------------------------
  {
    id: "bio-x-dna-structure",
    name: "DNA Structure — Build the Double Helix",
    description:
      "Drag adenine, thymine, guanine and cytosine into the right pairs along a sugar-phosphate backbone. Understand antiparallel strands, hydrogen bonds, and Chargaff's rule firsthand.",
    category: "biology",
    subcategory: "genetics",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/basics/builddna/",
    thumbnailEmoji: "🧬",
    tags: ["DNA", "double helix", "adenine", "thymine", "guanine", "cytosine", "base pair"],
  },
  {
    id: "bio-x-dna-replication",
    name: "DNA Replication — Semiconservative",
    description:
      "Unzip a parent DNA molecule and watch helicase, primase, DNA polymerase, and ligase build two identical daughter strands. See the leading vs lagging strand and Okazaki fragments.",
    category: "biology",
    subcategory: "molecular biology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://www.biologysimulations.com/dna-replication-1",
    thumbnailEmoji: "🧬",
    tags: ["DNA replication", "helicase", "polymerase", "ligase", "Okazaki", "leading strand"],
  },
  {
    id: "bio-x-transcription",
    name: "Transcription — DNA to mRNA",
    description:
      "Walk RNA polymerase along a gene as it reads the template strand and builds a complementary mRNA. See the promoter, terminator, and the role of TATA box.",
    category: "biology",
    subcategory: "molecular biology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/basics/transcribe/",
    thumbnailEmoji: "📝",
    tags: ["transcription", "RNA polymerase", "mRNA", "promoter", "template strand"],
  },
  {
    id: "bio-x-translation",
    name: "Translation — mRNA to Protein",
    description:
      "Match codons to anticodons at the ribosome A, P, and E sites. Watch tRNAs deliver amino acids, peptide bonds form, and a polypeptide chain grow until the stop codon.",
    category: "biology",
    subcategory: "molecular biology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/basics/translate/",
    thumbnailEmoji: "🔠",
    tags: ["translation", "ribosome", "tRNA", "codon", "anticodon", "protein synthesis"],
  },
  {
    id: "bio-x-genetic-code",
    name: "The Genetic Code — Codon Table",
    description:
      "Type any RNA sequence and decode it into amino acids using the codon table. See why the code is degenerate, what the start codon AUG does, and what UAA/UAG/UGA stop codons mean.",
    category: "biology",
    subcategory: "molecular biology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/basics/translate/",
    thumbnailEmoji: "🔡",
    tags: ["genetic code", "codon", "amino acid", "start codon", "stop codon", "degenerate"],
  },
  {
    id: "bio-x-mutations",
    name: "Mutations — Point, Frameshift, Silent",
    description:
      "Change a single base and see if the protein still works. Test silent, missense, nonsense, insertion and deletion mutations. Connect to sickle cell, cystic fibrosis, and how cancers begin.",
    category: "biology",
    subcategory: "genetics",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/basics/translate/",
    thumbnailEmoji: "⚠️",
    tags: ["mutation", "point mutation", "frameshift", "silent", "missense", "nonsense", "sickle cell"],
  },
  {
    id: "bio-x-punnett-square",
    name: "Punnett Square — Monohybrid Cross",
    description:
      "Cross two parents heterozygous for a trait and predict 3:1 phenotype, 1:2:1 genotype ratios. Test dominant/recessive, codominance and incomplete dominance.",
    category: "biology",
    subcategory: "genetics",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/inheritance/dropper/",
    thumbnailEmoji: "🧩",
    tags: ["Punnett square", "monohybrid", "dominant", "recessive", "phenotype", "genotype", "Mendel"],
  },
  {
    id: "bio-x-dihybrid-cross",
    name: "Dihybrid Cross & Independent Assortment",
    description:
      "Cross two traits at once and predict the classic 9:3:3:1 ratio. Demonstrates Mendel's law of independent assortment for genes on different chromosomes.",
    category: "biology",
    subcategory: "genetics",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/inheritance/dropper/",
    thumbnailEmoji: "🟦",
    tags: ["dihybrid", "9:3:3:1", "independent assortment", "Mendel", "genetics", "ratio"],
  },
  {
    id: "bio-x-sex-linkage",
    name: "Sex-Linked Inheritance",
    description:
      "Cross carriers of color blindness or hemophilia and see why these X-linked traits affect males more often. Trace the inheritance pattern through three generations.",
    category: "biology",
    subcategory: "genetics",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/inheritance/blood/",
    thumbnailEmoji: "🧮",
    tags: ["sex linked", "X linked", "color blindness", "hemophilia", "carrier", "pedigree"],
  },
  {
    id: "bio-x-pedigree",
    name: "Pedigree Analysis",
    description:
      "Use circles for females and squares for males to trace a genetic disease through a family tree. Decide whether a trait is autosomal-dominant, autosomal-recessive, or X-linked.",
    category: "biology",
    subcategory: "genetics",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/inheritance/blood/",
    thumbnailEmoji: "🌳",
    tags: ["pedigree", "family tree", "inheritance", "autosomal", "X-linked", "carrier"],
  },
  {
    id: "bio-x-pcr",
    name: "PCR — Amplify Any DNA",
    description:
      "Run the polymerase chain reaction. Heat to denature, cool to anneal primers, warm to extend with Taq polymerase — and double your DNA copies every cycle. Used in diagnostics and forensics.",
    category: "biology",
    subcategory: "laboratory",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/labs/pcr/",
    thumbnailEmoji: "🌡️",
    tags: ["PCR", "polymerase chain reaction", "primer", "Taq polymerase", "amplification"],
  },
  {
    id: "bio-x-gel-electrophoresis",
    name: "Gel Electrophoresis",
    description:
      "Load DNA fragments into agarose wells, apply voltage, and watch them separate by size. The technique behind DNA fingerprinting, paternity testing and crime forensics.",
    category: "biology",
    subcategory: "laboratory",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/labs/gel/",
    thumbnailEmoji: "📊",
    tags: ["gel electrophoresis", "agarose", "DNA fragment", "fingerprint", "forensics"],
  },
  {
    id: "bio-x-dna-fingerprinting",
    name: "DNA Profiling — Solve a Case",
    description:
      "Run real PCR/RFLP profiles from a crime scene against suspect samples and identify the match. See why short tandem repeats give every person a unique pattern.",
    category: "biology",
    subcategory: "laboratory",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/dna/profiling/",
    thumbnailEmoji: "🔎",
    tags: ["DNA profiling", "STR", "fingerprinting", "forensics", "crime", "match"],
  },
  ...
  // ----- Plant Biology -------------------------------------------------------
  {
    ...
    description:
      "Compare a typical plant cell (cell wall, large central vacuole, chloroplasts) with an animal cell. Identify what each unique structure does and why plants don't move.",
    category: "biology",
    subcategory: "cell biology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/cells/insideacell/",
    thumbnailEmoji: "🌿",
    tags: ["plant cell", "cell wall", "chloroplast", "vacuole", "animal cell", "comparison"],
  },
  {
    id: "bio-x-leaf-anatomy",
    name: "Leaf Anatomy — Cross Section",
    description:
      "Cut through a leaf and identify the upper epidermis, palisade mesophyll, spongy mesophyll, vascular bundle, lower epidermis and stomata. See where photosynthesis and gas exchange happen.",
    category: "biology",
    subcategory: "anatomy",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("diffusion"),
    thumbnailEmoji: "🍃",
    tags: ["leaf", "mesophyll", "stomata", "epidermis", "vascular bundle", "plant anatomy"],
  },
  {
    id: "bio-x-transpiration",
    name: "Transpiration — Water Up the Xylem",
    description:
      "See how water evaporates from leaf stomata, pulling a continuous column up the xylem from the roots — driven entirely by hydrogen bonding and capillary action.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("fluid-pressure-and-flow"),
    thumbnailEmoji: "💦",
    tags: ["transpiration", "xylem", "stomata", "cohesion-tension", "water potential", "plant"],
  },
  {
    id: "bio-x-stomata",
    name: "Stomata — Guard Cells & Gas Exchange",
    description:
      "Open and close stomata by adjusting guard cell turgor. See how plants balance the need for CO₂ against water loss, especially during drought.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("balloons-and-static-electricity"),
    thumbnailEmoji: "🌿",
    tags: ["stomata", "guard cell", "turgor", "gas exchange", "transpiration", "drought"],
  },
  {
    id: "bio-x-flower-anatomy",
    name: "Flower Anatomy — Petal to Pollen",
    description:
      "Identify sepal, petal, stamen (anther + filament), and carpel (stigma, style, ovary). Trace the path of a pollen grain from anther to ovule and follow fertilization.",
    category: "biology",
    subcategory: "anatomy",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/basics/cellcycle/",
    thumbnailEmoji: "🌸",
    tags: ["flower", "stamen", "carpel", "pollen", "ovule", "fertilization", "plant"],
  },
  {
    id: "bio-x-photosynthesis-light",
    name: "Light Intensity & Photosynthesis Rate",
    description:
      "Vary light intensity, CO₂ concentration and temperature, and measure oxygen production. Identify the limiting factor at each setting — a classic IB/A-level practical.",
    category: "biology",
    subcategory: "physiology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://www.biologysimulations.com/photosynthesis-1",
    thumbnailEmoji: "☀️",
    tags: ["photosynthesis", "limiting factor", "light intensity", "CO2", "rate", "plant"],
  },

  // ----- Microbiology --------------------------------------------------------
  {
    id: "bio-x-bacteria-structure",
    name: "Bacteria — Cell Structure",
    description:
      "Tour a prokaryotic cell: cell wall, capsule, plasma membrane, nucleoid, ribosomes, plasmids, pili, flagella. Compare gram-positive and gram-negative bacteria.",
    category: "biology",
    ...
    embedUrl: "https://learn.genetics.utah.edu/content/cells/scale/",
    thumbnailEmoji: "🦠",
    tags: ["bacteria", "prokaryote", "cell wall", "plasmid", "flagellum", "gram stain"],
  },
  {
    id: "bio-x-virus-structure",
    name: "Virus Anatomy & Replication",
    description:
      "Inspect the capsid, envelope, and genome of viruses including influenza, HIV, and SARS-CoV-2. Step through attachment, entry, replication, assembly and release.",
    category: "biology",
    subcategory: "microbiology",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://www.3dmol.org/",
    thumbnailEmoji: "🦠",
    tags: ["virus", "capsid", "envelope", "lytic", "lysogenic", "replication", "HIV"],
  },
  {
    id: "bio-x-antibiotic-resistance",
    name: "Antibiotic Resistance — Evolution in 24 Hours",
    description:
      "Treat a bacterial population with antibiotics and watch random mutations confer resistance. The same evolution that turns hospital infections into superbugs.",
    category: "biology",
    subcategory: "evolution",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("natural-selection"),
    thumbnailEmoji: "💊",
    tags: ["antibiotic", "resistance", "MRSA", "selection", "evolution", "mutation"],
  },
  ...
  // ----- Ecology -------------------------------------------------------------
  {
    ...
    description:
      "Build a food web with producers, primary consumers, secondary consumers, tertiary consumers and decomposers. Remove a species and watch the cascade of effects.",
    category: "biology",
    subcategory: "ecology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("natural-selection"),
    thumbnailEmoji: "🌐",
    tags: ["food web", "trophic level", "producer", "consumer", "decomposer", "ecosystem"],
  },
  {
    id: "bio-x-energy-pyramid",
    name: "Energy Pyramid — 10% Rule",
    description:
      "See why only ~10% of energy is passed up each trophic level. Calculate biomass loss from grass to grasshopper to frog to snake to hawk.",
    category: "biology",
    subcategory: "ecology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("energy-forms-and-changes"),
    thumbnailEmoji: "🔺",
    tags: ["energy pyramid", "trophic level", "10 percent rule", "biomass", "ecology"],
  },
  {
    id: "bio-x-carbon-cycle",
    name: "Carbon Cycle",
    description:
      "Follow a carbon atom through photosynthesis, respiration, combustion, decomposition, ocean dissolution, and fossil fuel formation. Understand how human activity tips the natural balance.",
    category: "biology",
    subcategory: "ecology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("greenhouse-effect"),
    thumbnailEmoji: "♻️",
    tags: ["carbon cycle", "photosynthesis", "respiration", "fossil fuel", "biogeochemical"],
  },
  {
    id: "bio-x-nitrogen-cycle",
    name: "Nitrogen Cycle",
    description:
      "Trace nitrogen through fixation by bacteria, nitrification, assimilation by plants, ammonification, and denitrification back to N₂. The reason fertilizers work and why too much causes algal blooms.",
    category: "biology",
    subcategory: "ecology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("concentration"),
    thumbnailEmoji: "🌾",
    tags: ["nitrogen cycle", "fixation", "nitrification", "denitrification", "fertilizer", "ecology"],
  },
  {
    id: "bio-x-population-growth",
    name: "Population Growth — Exponential vs Logistic",
    description:
      "Plot bacteria, rabbits, or humans against unlimited resources (exponential) and against carrying capacity (logistic). See where each model breaks down in the real world.",
    category: "biology",
    subcategory: "ecology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("natural-selection"),
    thumbnailEmoji: "📈",
    tags: ["population growth", "exponential", "logistic", "carrying capacity", "K", "ecology"],
  },
  {
    id: "bio-x-predator-prey",
    name: "Predator-Prey Cycles",
    description:
      "Run a Lotka-Volterra simulation of foxes and rabbits. Watch oscillations, lags, and what happens when you remove the top predator entirely.",
    category: "biology",
    subcategory: "ecology",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("natural-selection"),
    thumbnailEmoji: "🦊",
    tags: ["predator-prey", "Lotka-Volterra", "oscillation", "ecology", "population"],
  },

  // ----- Evolution -----------------------------------------------------------
  {
    id: "bio-x-peppered-moth",
    name: "Peppered Moth — Industrial Melanism",
    description:
      "Set tree-bark color (clean → soot-blackened) and watch light vs dark moths get picked off by birds. The textbook real-world demonstration of natural selection.",
    category: "biology",
    subcategory: "evolution",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://askabiologist.asu.edu/peppered-moths-game/play.html",
    thumbnailEmoji: "🦋",
    tags: ["peppered moth", "industrial melanism", "natural selection", "evolution", "camouflage"],
  },
  {
    id: "bio-x-hardy-weinberg",
    name: "Hardy-Weinberg Equilibrium",
    description:
      "Test the five conditions for genetic equilibrium and watch allele frequencies stay or shift. The mathematical baseline against which all real evolution is measured.",
    category: "biology",
    subcategory: "evolution",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/evolution/drift/",
    thumbnailEmoji: "🧮",
    tags: ["Hardy-Weinberg", "allele frequency", "equilibrium", "p", "q", "population genetics"],
  },
  {
    id: "bio-x-phylogenetic-tree",
    name: "Reading a Phylogenetic Tree",
    description:
      "Interpret nodes, branches, and the most recent common ancestor. Compare cladistic groups and learn why a hippo is more closely related to a whale than to a pig.",
    category: "biology",
    subcategory: "evolution",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://learn.genetics.utah.edu/content/evolution/treethink/",
    thumbnailEmoji: "🌳",
    tags: ["phylogeny", "cladogram", "common ancestor", "tree of life", "evolution"],
  },

  // ==========================================================================
  //  CHEMISTRY EXPANSION — Higher Secondary Curriculum
  //  Atomic structure · Bonding · Reactions · Organic · Equilibrium · Thermo
  // ==========================================================================

  // ----- Atomic Structure ----------------------------------------------------
  {
    id: "chem-x-atomic-models",
    name: "Atomic Models — Dalton to Quantum",
    description:
      "Trace the history of the atom: Dalton's billiard ball, Thomson's plum pudding, Rutherford's nucleus, Bohr's orbits, and the modern quantum mechanical cloud. Each model fixes the previous one's failure.",
    category: "chemistry",
    subcategory: "atomic structure",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("models-of-the-hydrogen-atom"),
    thumbnailEmoji: "🌀",
    tags: ["atomic model", "Dalton", "Thomson", "Rutherford", "Bohr", "quantum", "history"],
  },
  {
    id: "chem-x-rutherford-experiment",
    name: "Rutherford Gold Foil Experiment",
    description:
      "Fire alpha particles at gold foil and watch most pass through but a few bounce back. Discover why this single experiment killed the plum-pudding model and revealed the atomic nucleus.",
    category: "chemistry",
    subcategory: "atomic structure",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("rutherford-scattering"),
    thumbnailEmoji: "💫",
    tags: ["Rutherford", "gold foil", "alpha particle", "nucleus", "scattering"],
  },
  {
    id: "chem-x-electron-configuration",
    name: "Electron Configuration & Aufbau",
    description:
      "Fill orbitals 1s, 2s, 2p, 3s … in the Aufbau order. Apply the Pauli exclusion principle and Hund's rule, and predict the configuration of any element from H to Kr.",
    category: "chemistry",
    subcategory: "atomic structure",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("build-an-atom"),
    thumbnailEmoji: "⚛️",
    tags: ["electron configuration", "Aufbau", "Pauli", "Hund's rule", "orbital", "subshell"],
  },
  {
    id: "chem-x-orbitals",
    name: "Atomic Orbitals — s, p, d, f Shapes",
    description:
      "Visualize the spherical s orbital, dumbbell-shaped p orbitals, cloverleaf d orbitals and complex f orbitals in 3D. Where electrons actually live around an atom.",
    category: "chemistry",
    subcategory: "atomic structure",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://www.3dmol.org/",
    thumbnailEmoji: "☁️",
    tags: ["orbital", "s orbital", "p orbital", "d orbital", "quantum number", "shape"],
  },
  {
    id: "chem-x-periodic-trends",
    name: "Periodic Trends — Across & Down",
    description:
      "Watch atomic radius shrink across a period and grow down a group. Track ionization energy, electronegativity, and electron affinity, and explain each trend with effective nuclear charge.",
    category: "chemistry",
    ...
    embedUrl: phet("isotopes-and-atomic-mass"),
    thumbnailEmoji: "📊",
    tags: ["periodic trend", "atomic radius", "ionization energy", "electronegativity", "nuclear charge"],
  },
  {
    id: "chem-x-ionization-energy",
    name: "Ionization Energy — Removing Electrons",
    description:
      "Pull electrons off elements one at a time and watch successive ionization energies jump when you hit a noble-gas core. Direct evidence of electron shells.",
    category: "chemistry",
    subcategory: "atomic structure",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("build-an-atom"),
    thumbnailEmoji: "⚡",
    tags: ["ionization energy", "electron", "shell", "noble gas", "successive ionization"],
  },
  {
    id: "chem-x-quantum-numbers",
    name: "Quantum Numbers — n, l, mₗ, mₛ",
    description:
      "Each electron has a unique address. Set principal (n), angular (l), magnetic (mₗ) and spin (mₛ) quantum numbers and see which orbital you've described.",
    category: "chemistry",
    subcategory: "atomic structure",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("models-of-the-hydrogen-atom"),
    thumbnailEmoji: "🔢",
    tags: ["quantum numbers", "principal", "angular", "magnetic", "spin", "orbital"],
  },
  {
    id: "chem-x-emission-spectra",
    name: "Atomic Emission Spectra",
    description:
      "Heat hydrogen, helium, sodium and mercury and look at the bright-line spectrum each emits. The basis of how astronomers know what stars are made of.",
    category: "chemistry",
    subcategory: "spectroscopy",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("blackbody-spectrum"),
    thumbnailEmoji: "🌈",
    tags: ["emission spectrum", "Balmer", "hydrogen", "spectroscopy", "line spectrum"],
  },

  // ----- Chemical Bonding ----------------------------------------------------
  {
    id: "chem-x-ionic-bond",
    name: "Ionic Bonding — Na + Cl → NaCl",
    description:
      "Transfer one electron from sodium to chlorine and watch a +1 cation pair with a −1 anion. Form NaCl, MgO, CaCl₂ and predict the formula of any binary ionic compound.",
    category: "chemistry",
    subcategory: "bonding",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("atomic-interactions"),
    thumbnailEmoji: "🔗",
    tags: ["ionic bond", "cation", "anion", "electron transfer", "NaCl", "salt"],
  },
  {
    id: "chem-x-covalent-bond",
    name: "Covalent Bonding — Sharing Electrons",
    description:
      "Build H₂, O₂, N₂, H₂O and CH₄ by sharing electron pairs. Distinguish single, double, and triple bonds and see why each has a different length and strength.",
    category: "chemistry",
    subcategory: "bonding",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("build-a-molecule"),
    thumbnailEmoji: "🤝",
    tags: ["covalent bond", "shared electron", "single bond", "double bond", "triple bond"],
  },
  {
    id: "chem-x-lewis-structures",
    name: "Lewis Dot Structures",
    description:
      "Draw the Lewis structure of any small molecule. Count valence electrons, assign bonds and lone pairs, and check the octet rule. Includes exceptions like BF₃ and SF₆.",
    category: "chemistry",
    subcategory: "bonding",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("molecule-shapes"),
    thumbnailEmoji: "🔢",
    tags: ["Lewis structure", "valence electron", "octet rule", "lone pair", "dot structure"],
  },
  {
    id: "chem-x-vsepr",
    name: "VSEPR — Predict Molecular Shape",
    description:
      "Apply Valence Shell Electron Pair Repulsion to predict linear, trigonal planar, tetrahedral, trigonal bipyramidal, and octahedral geometries — and the bent, pyramidal variants caused by lone pairs.",
    category: "chemistry",
    subcategory: "bonding",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("molecule-shapes"),
    thumbnailEmoji: "📐",
    tags: ["VSEPR", "molecular geometry", "tetrahedral", "trigonal", "linear", "lone pair"],
  },
  {
    id: "chem-x-hybridization",
    name: "Orbital Hybridization — sp, sp², sp³",
    description:
      "See methane (sp³), ethylene (sp²) and acetylene (sp) form by mixing s and p orbitals. The reason carbon's geometry varies and organic chemistry is so rich.",
    category: "chemistry",
    subcategory: "bonding",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://molview.org/?q=ethylene",
    thumbnailEmoji: "🔬",
    tags: ["hybridization", "sp3", "sp2", "sp", "carbon", "methane", "ethylene"],
  },
  {
    id: "chem-x-polar-bonds",
    name: "Polar vs Non-Polar Bonds",
    description:
      "Compare electronegativities of two atoms. Below 0.4 is non-polar covalent, 0.4–1.7 is polar covalent, above 1.7 is ionic. Predict bond character for any pair.",
    category: "chemistry",
    subcategory: "bonding",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("molecule-polarity"),
    thumbnailEmoji: "↔️",
    tags: ["polar bond", "non-polar", "electronegativity", "dipole", "bond character"],
  },
  {
    id: "chem-x-imf",
    name: "Intermolecular Forces — H-bonds to LDF",
    description:
      "Rank London dispersion, dipole-dipole, and hydrogen bonding by strength. Explains why water boils at 100 °C but methane stays gas to −161 °C.",
    category: "chemistry",
    subcategory: "bonding",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("states-of-matter"),
    thumbnailEmoji: "💧",
    tags: ["intermolecular force", "hydrogen bond", "dipole-dipole", "London dispersion", "boiling point"],
  },
  {
    id: "chem-x-hydrogen-bonding",
    name: "Hydrogen Bonding in Water",
    description:
      "Watch water molecules link via O-H ⋯ O hydrogen bonds. The reason ice is less dense than water, why DNA holds together, and why water has such a high specific heat.",
    category: "chemistry",
    subcategory: "bonding",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("states-of-matter"),
    thumbnailEmoji: "💧",
    tags: ["hydrogen bond", "water", "ice", "DNA", "boiling point", "cohesion"],
  },
  {
    id: "chem-x-metallic-bond",
    name: "Metallic Bonding — Sea of Electrons",
    description:
      "See positive metal cations sitting in a delocalized sea of valence electrons. Explains why metals conduct, are malleable, ductile, and shiny.",
    category: "chemistry",
    subcategory: "bonding",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("circuit-construction-kit-dc"),
    thumbnailEmoji: "🔩",
    tags: ["metallic bond", "delocalized electron", "conductor", "malleable", "ductile"],
  },

  // ----- Reactions & Stoichiometry -------------------------------------------
  {
    id: "chem-x-reaction-types",
    name: "Reaction Types — 5 Categories",
    description:
      "Classify any equation as combination, decomposition, single replacement, double replacement, or combustion. Predict products from reactants using activity series and solubility rules.",
    category: "chemistry",
    subcategory: "reactions",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("reactants-products-and-leftovers"),
    thumbnailEmoji: "🔁",
    tags: ["reaction type", "synthesis", "decomposition", "replacement", "combustion"],
  },
  {
    id: "chem-x-balancing-eq",
    name: "Balancing Chemical Equations",
    description:
      "Practice balancing equations from H₂ + O₂ → H₂O up to combustion of octane. Conservation of mass made visible — atoms in must equal atoms out.",
    category: "chemistry",
    subcategory: "reactions",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("balancing-chemical-equations"),
    thumbnailEmoji: "⚖️",
    tags: ["balancing", "equation", "stoichiometry", "conservation of mass", "coefficient"],
  },
  {
    id: "chem-x-stoichiometry",
    name: "Stoichiometry — Limiting Reactant",
    description:
      "Mix reactants in different mole ratios and find the limiting reagent. Calculate theoretical yield, percent yield, and excess reactant left over.",
    category: "chemistry",
    subcategory: "reactions",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("reactants-products-and-leftovers"),
    thumbnailEmoji: "🧮",
    tags: ["stoichiometry", "limiting reactant", "excess", "theoretical yield", "percent yield"],
  },
  {
    id: "chem-x-redox",
    name: "Redox — Oxidation & Reduction",
    description:
      "Track electrons in every reaction. Assign oxidation numbers, identify the oxidizing and reducing agent, and balance redox equations using half-reactions.",
    category: "chemistry",
    subcategory: "reactions",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("balancing-chemical-equations"),
    thumbnailEmoji: "🔄",
    tags: ["redox", "oxidation", "reduction", "half-reaction", "OIL RIG", "oxidizing agent"],
  },
  {
    id: "chem-x-rxn-rate",
    name: "Reaction Rate — Concentration & Temperature",
    description:
      "Vary concentration, temperature, surface area and catalysts and watch reaction rate change. Plot rate vs concentration to determine reaction order.",
    category: "chemistry",
    subcategory: "kinetics",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("reactions-and-rates"),
    thumbnailEmoji: "⏱️",
    tags: ["reaction rate", "kinetics", "rate law", "order", "concentration", "temperature"],
  },
  {
    id: "chem-x-activation-energy",
    name: "Activation Energy & Catalysts",
    description:
      "Plot the energy profile of a reaction. See how a catalyst lowers the activation barrier without being consumed — the same idea behind every enzyme in your body.",
    category: "chemistry",
    subcategory: "kinetics",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("reactions-and-rates"),
    thumbnailEmoji: "🚧",
    tags: ["activation energy", "catalyst", "transition state", "energy profile", "Arrhenius"],
  },
  {
    id: "chem-x-equilibrium",
    name: "Chemical Equilibrium — Forward = Reverse",
    description:
      "Reach a state where forward and reverse rates are equal. Calculate Kc, see how concentration changes shift the system, and link to Le Chatelier's principle.",
    category: "chemistry",
    ...
    embedUrl: phet("reactants-products-and-leftovers"),
    thumbnailEmoji: "⚖️",
    tags: ["equilibrium", "Kc", "Kp", "dynamic", "forward", "reverse"],
  },
  {
    id: "chem-x-le-chatelier",
    name: "Le Chatelier's Principle",
    description:
      "Stress an equilibrium by adding reactant, removing product, changing pressure, or changing temperature. Predict which way the system shifts to relieve the stress.",
    category: "chemistry",
    subcategory: "equilibrium",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("gas-properties"),
    thumbnailEmoji: "↔️",
    tags: ["Le Chatelier", "equilibrium shift", "stress", "pressure", "temperature", "concentration"],
  },

  // ----- Acids, Bases, pH ----------------------------------------------------
  {
    id: "chem-x-acid-base-defs",
    name: "Acid-Base Definitions — Arrhenius, Brønsted, Lewis",
    description:
      "Compare the three definitions: H⁺ donors (Arrhenius), proton transfer (Brønsted-Lowry), and electron-pair acceptors (Lewis). See which definition fits each reaction.",
    category: "chemistry",
    ...
    embedUrl: phet("acid-base-solutions"),
    thumbnailEmoji: "🧪",
    tags: ["Arrhenius", "Brønsted", "Lowry", "Lewis acid", "proton donor", "definitions"],
  },
  {
    id: "chem-x-strong-weak-acids",
    name: "Strong vs Weak Acids & Bases",
    description:
      "Compare full dissociation of HCl with partial dissociation of CH₃COOH. Watch ions form and calculate pH from concentration and Ka.",
    category: "chemistry",
    subcategory: "acids and bases",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("acid-base-solutions"),
    thumbnailEmoji: "🧪",
    tags: ["strong acid", "weak acid", "Ka", "Kb", "dissociation", "HCl", "acetic acid"],
  },
  {
    id: "chem-x-titration",
    name: "Acid-Base Titration",
    description:
      "Drip standardized NaOH into HCl and locate the equivalence point with phenolphthalein or methyl orange. Calculate unknown concentration from the burette reading.",
    category: "chemistry",
    subcategory: "laboratory",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("ph-scale"),
    thumbnailEmoji: "💧",
    tags: ["titration", "burette", "equivalence point", "indicator", "phenolphthalein", "concentration"],
  },
  {
    id: "chem-x-buffer",
    name: "Buffers — Resisting pH Change",
    description:
      "Build an acetic acid / acetate buffer. Add small amounts of strong acid or base and watch the buffer absorb the change. Apply Henderson-Hasselbalch.",
    category: "chemistry",
    subcategory: "acids and bases",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("ph-scale"),
    thumbnailEmoji: "🧪",
    tags: ["buffer", "Henderson-Hasselbalch", "weak acid", "conjugate base", "pH"],
  },

  // ----- Solutions & Concentration -------------------------------------------
  {
    id: "chem-x-solubility",
    name: "Solubility & Solubility Curves",
    description:
      "Vary temperature and watch solid solute dissolve in water. Plot solubility curves for KNO₃, NaCl, NH₃ — and explain why gases dissolve less when warm but solids dissolve more.",
    category: "chemistry",
    subcategory: "solutions",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("concentration"),
    thumbnailEmoji: "🧂",
    tags: ["solubility", "saturated", "supersaturated", "solubility curve", "temperature"],
  },
  {
    id: "chem-x-dilution",
    name: "Dilution — M₁V₁ = M₂V₂",
    description:
      "Take a stock solution, add water, and watch concentration drop. Practice the dilution formula and learn serial dilutions used in labs and pharmaceuticals.",
    category: "chemistry",
    subcategory: "solutions",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("molarity"),
    thumbnailEmoji: "💧",
    tags: ["dilution", "M1V1", "stock solution", "molarity", "serial dilution"],
  },
  {
    id: "chem-x-electrolytes",
    name: "Electrolytes — Strong, Weak, Non",
    description:
      "Test conductivity of NaCl, sugar, and acetic acid solutions. Strong electrolytes fully dissociate, weak ones partially, non-electrolytes not at all.",
    category: "chemistry",
    subcategory: "solutions",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("circuit-construction-kit-dc"),
    thumbnailEmoji: "⚡",
    tags: ["electrolyte", "conductivity", "dissociation", "ions", "solution"],
  },

  // ----- Gas Laws & Phases ---------------------------------------------------
  {
    id: "chem-x-boyle-law",
    name: "Boyle's Law — P × V = constant",
    description:
      "Hold temperature fixed and squeeze a gas. Watch pressure rise as volume falls. Plot P vs V and P vs 1/V to confirm the inverse relationship.",
    category: "chemistry",
    subcategory: "gas laws",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("gas-properties"),
    thumbnailEmoji: "🎈",
    tags: ["Boyle's law", "pressure", "volume", "isothermal", "gas law"],
  },
  {
    id: "chem-x-charles-law",
    name: "Charles's Law — V/T = constant",
    description:
      "Hold pressure fixed and heat a gas. Watch volume expand linearly with absolute temperature. Extrapolate to absolute zero at −273.15 °C.",
    category: "chemistry",
    subcategory: "gas laws",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("gas-properties"),
    thumbnailEmoji: "🌡️",
    tags: ["Charles's law", "volume", "temperature", "isobaric", "absolute zero"],
  },
  {
    id: "chem-x-ideal-gas",
    name: "Ideal Gas Law — PV = nRT",
    description:
      "Combine Boyle, Charles, Avogadro and Gay-Lussac into one equation. Solve for any unknown given the other three, and see when real gases deviate from ideal.",
    category: "chemistry",
    subcategory: "gas laws",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("gas-properties"),
    thumbnailEmoji: "💨",
    tags: ["ideal gas law", "PV=nRT", "Avogadro", "Gay-Lussac", "moles"],
  },
  {
    id: "chem-x-phase-diagram",
    name: "Phase Diagram of Water",
    description:
      "Plot a P–T phase diagram. Find the triple point (273.16 K, 611 Pa), the critical point, and explain why ice skating works but skating on solid CO₂ doesn't.",
    category: "chemistry",
    subcategory: "states of matter",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("states-of-matter"),
    thumbnailEmoji: "📈",
    tags: ["phase diagram", "triple point", "critical point", "sublimation", "water"],
  },

  // ----- Thermochemistry -----------------------------------------------------
  {
    id: "chem-x-enthalpy",
    name: "Enthalpy — ΔH for Reactions",
    description:
      "Distinguish exothermic (ΔH < 0) from endothermic (ΔH > 0) reactions. Calculate ΔH from bond energies, formation enthalpies, and Hess's law.",
    category: "chemistry",
    subcategory: "thermochemistry",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("energy-forms-and-changes"),
    thumbnailEmoji: "🔥",
    tags: ["enthalpy", "exothermic", "endothermic", "delta H", "thermochemistry", "Hess"],
  },
  {
    id: "chem-x-calorimetry",
    name: "Calorimetry — q = mcΔT",
    description:
      "Burn a sample under a calorimeter. Measure water temperature change and use q = mcΔT to find the heat released — the technique behind nutrition labels and combustion analysis.",
    category: "chemistry",
    subcategory: "thermochemistry",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("energy-forms-and-changes"),
    thumbnailEmoji: "🔥",
    tags: ["calorimetry", "specific heat", "q=mcΔT", "heat", "calorimeter"],
  },
  {
    id: "chem-x-entropy",
    name: "Entropy — Disorder & Spontaneity",
    description:
      "Watch a drop of dye spread through water — entropy increasing. Predict ΔS for melting, boiling, dissolving, and reactions. Combine with ΔH in ΔG = ΔH − TΔS.",
    category: "chemistry",
    subcategory: "thermochemistry",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("diffusion"),
    thumbnailEmoji: "🌪️",
    tags: ["entropy", "disorder", "spontaneity", "second law", "Gibbs free energy"],
  },
  ...
  // ----- Organic Chemistry ---------------------------------------------------
  {
    ...
    name: "Alkanes — CₙH₂ₙ₊₂",
    description:
      "Build methane, ethane, propane, butane up to decane. See straight chains, branched isomers, and the saturated single-bond structure that defines paraffins.",
    category: "chemistry",
    subcategory: "organic",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://molview.org/?q=hexane",
    thumbnailEmoji: "🔗",
    tags: ["alkane", "saturated", "hydrocarbon", "methane", "ethane", "propane"],
  },
  {
    id: "chem-x-alkenes-alkynes",
    name: "Alkenes & Alkynes — Double & Triple Bonds",
    description:
      "Compare ethene (C=C) and ethyne (C≡C) with their alkane parents. See restricted rotation, sp² vs sp hybridization, and the cis-trans isomerism unique to alkenes.",
    category: "chemistry",
    subcategory: "organic",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://molview.org/?q=ethylene",
    thumbnailEmoji: "🔗",
    tags: ["alkene", "alkyne", "double bond", "triple bond", "ethylene", "acetylene"],
  },
  {
    id: "chem-x-isomers",
    name: "Isomers — Same Formula, Different Structure",
    description:
      "Build all five isomers of C₆H₁₄ — n-hexane, 2-methylpentane, 3-methylpentane, 2,2-dimethylbutane, 2,3-dimethylbutane. Then explore cis-trans and optical isomers.",
    category: "chemistry",
    subcategory: "organic",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://molview.org/?q=2-methylpentane",
    thumbnailEmoji: "🔀",
    tags: ["isomer", "structural", "geometric", "cis-trans", "optical", "stereoisomer"],
  },
  {
    id: "chem-x-functional-groups",
    name: "Functional Groups — IUPAC Cheat Sheet",
    description:
      "Spot alcohols (-OH), aldehydes (-CHO), ketones (C=O), carboxylic acids (-COOH), amines (-NH₂), esters (-COOR), and ethers in real molecules.",
    category: "chemistry",
    subcategory: "organic",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://molview.org/?q=glucose",
    thumbnailEmoji: "🏷️",
    tags: ["functional group", "alcohol", "aldehyde", "ketone", "carboxylic acid", "amine", "ester"],
  },
  {
    id: "chem-x-alcohols",
    name: "Alcohols — Methanol to Ethanol",
    description:
      "Compare methanol, ethanol, propanol, butanol. See how chain length affects boiling point and learn the difference between primary, secondary, and tertiary alcohols.",
    category: "chemistry",
    subcategory: "organic",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://molview.org/?q=ethanol",
    thumbnailEmoji: "🍷",
    tags: ["alcohol", "ethanol", "methanol", "primary", "secondary", "tertiary", "OH group"],
  },
  {
    id: "chem-x-carboxylic-acid",
    name: "Carboxylic Acids — Vinegar & Beyond",
    description:
      "Build acetic acid (vinegar), citric acid, fatty acids and amino acids. Explore why -COOH is acidic and how it neutralizes bases and forms esters.",
    category: "chemistry",
    subcategory: "organic",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://molview.org/?q=acetic acid",
    thumbnailEmoji: "🧪",
    tags: ["carboxylic acid", "acetic acid", "vinegar", "fatty acid", "COOH"],
  },
  {
    id: "chem-x-esters",
    name: "Esters & Esterification",
    description:
      "Combine a carboxylic acid with an alcohol to make an ester — the molecules that smell like fruit and flowers. Watch H₂O leave in this classic condensation reaction.",
    category: "chemistry",
    subcategory: "organic",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://molview.org/?q=ethyl acetate",
    thumbnailEmoji: "🍓",
    tags: ["ester", "esterification", "condensation", "fragrance", "carboxylic acid", "alcohol"],
  },
  {
    id: "chem-x-benzene",
    name: "Benzene & Aromatic Rings",
    description:
      "Visualize benzene's 6-membered ring with delocalized π electrons. See why it's flat, why all C-C bonds are equal length, and why aromatic compounds smell.",
    category: "chemistry",
    subcategory: "organic",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://molview.org/?q=benzene",
    thumbnailEmoji: "🔄",
    tags: ["benzene", "aromatic", "delocalized", "ring", "pi bond", "Kekule"],
  },
  {
    id: "chem-x-polymers",
    name: "Polymers — Monomer to Macromolecule",
    description:
      "Link ethylene monomers into polyethylene. Compare addition polymers (PE, PP, PVC) with condensation polymers (nylon, polyester). Includes natural polymers like proteins and starch.",
    category: "chemistry",
    subcategory: "organic",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://molview.org/?q=polyethylene",
    thumbnailEmoji: "🧵",
    tags: ["polymer", "monomer", "polyethylene", "nylon", "addition", "condensation"],
  },
  {
    id: "chem-x-biomolecules-carbs",
    name: "Carbohydrates — Glucose to Cellulose",
    description:
      "Build glucose, fructose, sucrose, starch and cellulose. See how monosaccharides link via glycosidic bonds and why humans can digest starch but not cellulose.",
    category: "chemistry",
    subcategory: "biochemistry",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://molview.org/?q=glucose",
    thumbnailEmoji: "🍞",
    tags: ["carbohydrate", "glucose", "sucrose", "starch", "cellulose", "monosaccharide"],
  },
  {
    id: "chem-x-amino-acids",
    name: "Amino Acids — Building Proteins",
    description:
      "Inspect the 20 amino acids and their side chains: hydrophobic, polar, acidic, basic. Link them via peptide bonds and see how primary structure dictates a protein's shape.",
    category: "chemistry",
    subcategory: "biochemistry",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://molview.org/?q=glycine",
    thumbnailEmoji: "🧬",
    tags: ["amino acid", "peptide bond", "protein", "side chain", "polypeptide", "biochemistry"],
  },
  {
    id: "chem-x-lipids",
    name: "Lipids — Fats, Oils, Phospholipids",
    description:
      "Build saturated and unsaturated triglycerides, phospholipids and steroids like cholesterol. Understand why butter is solid but olive oil is liquid at room temperature.",
    category: "chemistry",
    subcategory: "biochemistry",
    gradeLevel: "High School",
    source: "Other",
    embedUrl: "https://molview.org/?q=cholesterol",
    thumbnailEmoji: "🥑",
    tags: ["lipid", "fat", "triglyceride", "phospholipid", "saturated", "unsaturated", "cholesterol"],
  },

  // ----- Electrochemistry ----------------------------------------------------
  {
    id: "chem-x-galvanic-cell",
    name: "Galvanic (Voltaic) Cell — Daniell Cell",
    description:
      "Build a Zn/Cu Daniell cell. Watch electrons flow from anode to cathode, ions cross the salt bridge, and use a standard reduction potential table to predict cell EMF.",
    category: "chemistry",
    subcategory: "electrochemistry",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("circuit-construction-kit-dc"),
    thumbnailEmoji: "🔋",
    tags: ["galvanic cell", "voltaic", "Daniell", "anode", "cathode", "salt bridge", "EMF"],
  },
  {
    id: "chem-x-electrolysis",
    name: "Electrolysis — Splitting Compounds",
    description:
      "Pass current through molten NaCl or aqueous CuSO₄ and watch products form at each electrode. The industrial process behind aluminum, chlorine, and electroplating.",
    category: "chemistry",
    subcategory: "electrochemistry",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("circuit-construction-kit-dc"),
    thumbnailEmoji: "⚡",
    tags: ["electrolysis", "electrode", "electroplating", "Faraday's law", "molten", "aqueous"],
  },
  {
    id: "chem-x-batteries",
    name: "How Batteries Work",
    description:
      "Compare alkaline, lead-acid, lithium-ion, and fuel cells. See the half-reactions inside each one and understand voltage, capacity, and rechargeability.",
    category: "chemistry",
    subcategory: "electrochemistry",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("circuit-construction-kit-dc"),
    thumbnailEmoji: "🔋",
    tags: ["battery", "alkaline", "lithium-ion", "fuel cell", "lead-acid", "rechargeable"],
  },

  // ----- Nuclear -------------------------------------------------------------
  {
    id: "chem-x-half-life",
    name: "Half-Life & Radioactive Decay",
    description:
      "Start with N₀ atoms of carbon-14 and watch them halve every 5,730 years. Calculate the age of a sample from its remaining fraction — the basis of radiocarbon dating.",
    category: "chemistry",
    subcategory: "nuclear",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("models-of-the-hydrogen-atom"),
    thumbnailEmoji: "☢️",
    tags: ["half-life", "radioactive decay", "carbon-14", "radiocarbon dating", "exponential"],
  },
  {
    id: "chem-x-decay-types",
    name: "Alpha, Beta & Gamma Decay",
    description:
      "Watch a heavy nucleus emit a helium-4 alpha particle, an electron beta, or a gamma photon. Predict the daughter nucleus and write balanced nuclear equations.",
    category: "chemistry",
    subcategory: "nuclear",
    gradeLevel: "High School",
    source: "PhET",
    embedUrl: phet("rutherford-scattering"),
    thumbnailEmoji: "☢️",
    tags: ["alpha decay", "beta decay", "gamma", "nuclear equation", "daughter nucleus"],
  },
  ...
  {
    id: "mathigon-polypad",
    name: "Polypad (Math Manipulatives)",
    description:
      "A virtual canvas with fraction bars, algebra tiles, tangrams and geometry tools for hands-on math.",
    category: "math",
    subcategory: "arithmetic",
    gradeLevel: "Middle School",
    source: "Other",
    ...
    thumbnailEmoji: "🧩",
    tags: ["manipulatives", "fractions", "algebra tiles", "geometry", "tangram"],
  },
  ...
  // ==========================================================================
  {
    ...
    description:
      "Build optical setups with mirrors, lenses and prisms — trace rays and see reflections, refractions and focal points.",
    category: "physics",
    subcategory: "optics",
    gradeLevel: "High School",
    source: "Other",
